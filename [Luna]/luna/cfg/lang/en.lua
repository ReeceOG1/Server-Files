  ...
  police = {
    ...
    menu = {
      ...
      check = {
        ...
        request_hide = "Hide card.",
        info = "<em>Money: £ </em>{1} <br /><br /><em>Inventory: </em>{2}<br /><br /><em>Weapons: </em>{3}",
        checked = "~b~You are currently being searched."
      },
      seize = {
        seized = "Seized {2} ~r~{1}",
        weapons = {
    ...
    identity = {
      info = "<em>Name: </em>{1}<br /><em>Age: </em>{3}<br /><em>Plate: </em>{4}<br /><em>Phone: </em>{5}<br />"
    }
  },
  emergency = {
    menu = {
