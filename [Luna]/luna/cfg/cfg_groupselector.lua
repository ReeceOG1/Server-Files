...
cfg.selectorTypes = {
    ["default"] = {
        _config = {name="Job Selector", blipid = 351, blipcolor = 47, permissions = {}, TextureDictionary = "banners",texture = "hall"},
        jobs = {
            {"AA Mechanic", 0},
            {"Royal Mail Driver", 0},
            {"Bus Driver", 0},
    ...
    ["NHS"] = {
        _config = {name="NHS Job", blipid = 351, blipcolor = 2, permissions = {"nhs.whitelisted"}, TextureDictionary = "banners", texture = "clockon"},
    ...
    ["HMP"] = {
        _config = {name="Prison Guard", blipid = 351, blipcolor = 39, permissions = {"hmp.whitelisted"}, TextureDictionary = "banners", texture = "clockon"},
