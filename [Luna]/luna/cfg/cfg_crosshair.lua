...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("luna_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("luna_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("luna_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("luna_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("luna_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("luna_crosshair_gap")
    ...
    local red = GetResourceKvpInt("luna_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("luna_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("luna_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('luna_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('luna_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('luna_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('luna_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('luna_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('luna_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('luna_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('luna_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('luna_crosshair_green', cfg.options.colour.green)
end
