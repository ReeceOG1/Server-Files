...
-- RMenu.Add('CinematicMenu', 'MainMenu', RageUI.CreateMenu("", "LUNA Cinematic", 1300,100, "banners", "settings")) 
...
--                 if Selected then
--                     SendNUIMessage({act="openurl",url="https://discord.gg/luna5m"})
--                 end
--             end)
--         end
--        end)
...
--     TriggerServerEvent("LUNA:RequestCinematic")
--     RageUI.Visible(RMenu:Get('CinematicMenu', 'MainMenu'), not RageUI.Visible(RMenu:Get('CinematicMenu', 'MainMenu')))
-- end)


-- function tLUNA.hasCinematicPermission()
--     HasCinematic = true
-- end

-- -- Probs not best way todo it but oh well it :)
-- local a = "EXTRASUNNY"
