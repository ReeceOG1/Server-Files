...
RegisterNetEvent("LUNA:adminTicketFeedback",function(aK)

    local aL, aM = tLUNA.getPlayerVehicle()
    ...
    if aN then
        ...
        tLUNA.clientPrompt("Attached Message","",function(aP)

            TriggerServerEvent("LUNA:adminTicketFeedback", aK, aN, aP)
        ...
        TriggerServerEvent("LUNA:adminTicketNoFeedback", aK)
