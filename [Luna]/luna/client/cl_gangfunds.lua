...
-- RegisterNetEvent("LUNA:sendGangFunds")
-- AddEventHandler("LUNA:sendGangFunds",function(funds)
--     gangfunds = funds
-- end)


-- RMenu.Add('LUNAGangFunds', 'main', RageUI.CreateMenu("Gang Funds", "~b~Gang Funds", 1350, 50))
-- RageUI.CreateWhile(1.0, true, function()
--     if RageUI.Visible(RMenu:Get('LUNAGangFunds', 'main')) then
--         RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
--             RageUI.Separator('£'..getMoneyStringFormatted(gangfunds))
...
--                     TriggerServerEvent('LUNA:getGangFunds')
--                     RageUI.Visible(RMenu:Get('LUNAGangFunds', 'main'), true) 
--                     inGangFunds = true
--                     currentAmmunition = k 
--                 end
--             end
...
--                 RageUI.Visible(RMenu:Get('LUNAGangFunds', 'main'), false) 
--                 inGangFunds = false
