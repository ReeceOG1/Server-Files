...
RegisterNetEvent("LUNA:announceRestart")
AddEventHandler("LUNA:announceRestart",function(a,b)
...
RegisterNetEvent("LUNA:smallAnnouncement",function(f,g,h,i)
    tLUNA.announceMpSmallMsg(f,g,h,i)
end)
function tLUNA.announceMpSmallMsg(f,g,h,i)
