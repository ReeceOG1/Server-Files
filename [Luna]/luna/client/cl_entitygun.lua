...
RegisterNetEvent("LUNA:EntityCleanupGun")
AddEventHandler("LUNA:EntityCleanupGun", function()
    ...
    if EntityCleanupGun then 
        ...
        tLUNA.notify("~g~Entity cleanup gun enabled.")
    else 
        tLUNA.notify("~r~Entity cleanup gun disabled.")
