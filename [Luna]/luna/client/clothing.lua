...
RMenu.Add('LUNAClothing', 'main', RageUI.CreateMenu("", "Clothing Store",1300, 100, "banners", "clothes"))
RMenu.Add('LUNAClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("LUNAClothing", "main")))
RMenu.Add('LUNAClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("LUNAClothing", "main")))
RMenu.Add('LUNAClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("LUNAClothing", "main")))
RMenu.Add('LUNAClothing', 'wardrobesub',  RageUI.CreateSubMenu(RMenu:Get("LUNAClothing", "main")))
RMenu.Add('wardrobesub', 'clothingsub',  RageUI.CreateSubMenu(RMenu:Get("LUNAClothing", "wardrobesub")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('LUNAClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button("Change your Clothes", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("LUNAClothing", "clothingsubmenu"))
            RageUI.Button("Change Gender", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("LUNAClothing", "changegendersubmenu"))
           -- RageUI.Button("Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("LUNAClothing", "changepedmenu"))
            RageUI.Button("~y~Wardrobe", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("LUNAClothing", "wardrobesub"))
    ...
    if RageUI.Visible(RMenu:Get('LUNAClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end,RMenu:Get("LUNAClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('LUNAClothing', 'wardrobesub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if tLUNA.isPlatClub() or tLUNA.isPlusClub() then
                RageUI.Button("Save Outfit", nil, {RightLabel = "→→→"}, true, function(Hovered, Active, Selected) 
                    if Selected then
                ...
                if Selected then
                    for k, v in pairs(wardrobe) do
                        if k == currentOutfit then
                            ...
                            tLUNA.setCustomization(v)

                            SetTimeout(50, function()
                                SetPedArmour(PlayerPedId(), savedArmour)
                                TriggerServerEvent('LUNA:changeHairStyle')
                            end)
                        end
                    end
                end
            end, RMenu:Get('LUNAClothing', 'wardrobesub'))
    
            RageUI.Button("Delete Outfit", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
                if Selected then
    ...
    if RageUI.Visible(RMenu:Get('LUNAClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('LUNAClothing', 'clothingsubmenu')) then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.List("Hats / Helmets", Hats.Max, Hats.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = "hats";
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Hats.TextureIndex .. "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 0, Hats.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Glasses", Glasses.Max, Glasses.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    ...
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Glasses.TextureIndex .. "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 1, Glasses.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Ear Accessories", Earings.Max, Earings.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    ...
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Earings.TextureIndex .. "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 2, Earings.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Face", Face.Max, Face.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 0;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Face.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 0, Face.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Mask", Mask.Max, Mask.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 1;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Mask.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 1, Mask.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Hair", Hair.Max, Hair.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 2;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Hair.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 2, Hair.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Shirts / Jackets", Torso2.Max, Torso2.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 11;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Torso2.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 11,  tonumber(Torso2.Index)),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Arms / Torso", Torso.Max, Torso.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 3;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Torso.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 3, Torso.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Watches", Watches.Max, Watches.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    ...
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Watches.TextureIndex .. "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 6, Watches.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Bracelets", Bracelets.Max, Bracelets.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    ...
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Bracelets.TextureIndex .. "/" .. GetNumberOfPedPropTextureVariations(PlayerPedId(), 7, Bracelets.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Undershirt", Undershirt.Max, Undershirt.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 8;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Undershirt.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 8, Undershirt.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Legs", Legs.Max, Legs.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 4;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Legs.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 4, Legs.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Shoes", Shoes.Max, Shoes.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 6;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Shoes.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 6, Shoes.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Bags", Parachute.Max, Parachute.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 5;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Parachute.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 5, Parachute.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Vests", Kevlar.Max, Kevlar.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 9;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Kevlar.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 9, Kevlar.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Accessories", Accessory.Max, Accessory.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 7;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Accessory.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 7, Accessory.Index),  255, 255, 255, 255, 6, 0)
            ...
            RageUI.List("Badges", Badge.Max, Badge.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 10;
                    DrawAdvancedText(0.827, 0.597, 0.00, 0.0028, 0.4, 'Current Texture Index: ' .. Badge.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 10, Badge.Index),  255, 255, 255, 255, 6, 0)
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('LUNAClothing', 'main'), true) 
            Face.Index = GetPedDrawableVariation(ped, 0)
            Face.TextureIndex = GetPedTextureVariation(ped, 0)
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('LUNAClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('LUNAClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('LUNAClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
...
RegisterCommand('yoda', function(source, args, RawCommand)
        if getUserId() == 2 then
        tLUNA.setCustomization({model = "LegoYoda"})
   --     ExecuteCommand('storeallweapons') 
        Wait(750)
        SetEntityHealth(PlayerPedId(), 200) 
    end
...
RegisterCommand('hulk', function(source, args, RawCommand)
    ...
    tLUNA.setCustomization({model = "HULKv"})
   -- ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
...
RegisterCommand('minion', function(source, args, RawCommand)
    ...
    tLUNA.setCustomization({model = "MinionYellow"})
   -- ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
