-- local a = module("luna-weapons", "cfg/cfg_weaponsonback")
-- local b = module("luna-weapons", "cfg/weapons")
...
--     local i = tLUNA.getWeapons()
--     local j = false
--     local k = globalOnPoliceDuty and tLUNA.getPlayerVehicle() ~= 0
--     for l in pairs(i) do
--         local m = GetHashKey(l)
--         local n = a.weapons[m]
--         if n then
--             local o =
--                 (not k or n.type ~= "Heavy") and (tLUNA.isEmergencyService() or not isInGreenzone) and
--                 not tLUNA.isPlayerInAnimalForm()
...
--                 playerIndex = -1,
--                 weapons = D,
--                 diagonal = Player(z).state.weaponsDiagonal,
--                 frontAR = Player(z).state.frontAR
--             }
--         end
--     end
-- )
