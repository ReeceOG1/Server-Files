-- this file define global tools required by LUNA and LUNA extensions
...
function module(rsc, path)
  if path == nil then -- shortcut for luna, can omit the resource parameter
    path = rsc
    rsc = "luna"
  end
...
local Debug = module("luna", "lib/Debug")
