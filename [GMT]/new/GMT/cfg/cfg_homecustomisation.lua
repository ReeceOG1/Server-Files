...
cfg.tvScriptRenderTargetTextures = {
    [`prop_monitor_01b`] = "script_rt_gmttv2",
    [`prop_tv_flat_01`] = "script_rt_gmttv5",
    [`sm_prop_smug_tv_flat_01`] = "script_rt_gmttv8",
    [`prop_tv_flat_02b`] = "script_rt_gmttv6",
    [`prop_tv_flat_03b`] = "script_rt_gmttv7",
    [`apa_mp_h_str_avunits_04`] = "script_rt_gmttv1",
    [`v_ilev_mm_screen2`] = "script_rt_gmttv9",
    [`prop_tv_02`] = "script_rt_gmttv3",
    [`prop_tv_03`] = "script_rt_gmttv4"
}
