...
RMenu.Add("vkint","mainmenu",RageUI.CreateMenu("Teleporter", "Main Menu", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight()))
local b = nil
local function c(d)
    if tGMT.getPlayerCombatTimer() > 0 then
        tGMT.notify("You can not teleport whilst you have a combat timer.")
        return
    end
...
Citizen.CreateThread(function()
    for f, d in pairs(a) do
        ...
        tGMT.createArea("vkint_" .. d.id,d.position,2.0,10.0,l,m,function()end,d)
    end
end)
