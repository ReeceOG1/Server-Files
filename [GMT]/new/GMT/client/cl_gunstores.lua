...
RMenu:Get("GMTGunstore","mainmenu"):SetSubtitle("GUNSTORE")
                ...
                if string.sub(d.model,1,4)=="item"then 
                    ...
                    if g=="ammo"then 
                        if HasPedGotWeapon(tGMT.getPlayerPed(),GetHashKey(d.model),false)then 
                            ...
                            tGMT.notify("You do not have the body of this weapon to purchase ammo.")
                        end 
                    else 
            ...
            for K,U in pairs(P)do 
                ...
                local V=function()
                    if GetVehiclePedIsIn(tGMT.getPlayerPed(),false)==0 then 
                        ...
                        tGMT.notify("Exit your vehicle to access the gun store.")
                    end 
                end
                local W=function()
                    L(m)
