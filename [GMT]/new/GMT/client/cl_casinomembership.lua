...
RMenu.Add('gmthighrollers','confirmadd',RageUI.CreateSubMenu(RMenu:Get('gmthighrollers','casino'),"","Are you sure?",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
RMenu.Add('gmthighrollers','confirmremove',RageUI.CreateSubMenu(RMenu:Get('gmthighrollers','casino'),"","Are you sure?",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
