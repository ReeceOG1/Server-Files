...
RMenu.Add("scope","main",RageUI.CreateMenu("", "~b~Scope Settings", tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
...
function tGMT.doesCurrentWeaponHaveScope()
    local p = PlayerPedId()
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
        if i and (j or tGMT.doesCurrentWeaponHaveScope()) then
            if j then
