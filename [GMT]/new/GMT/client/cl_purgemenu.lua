...
local function u()
    ...
    if a then
        ...
        DrawAdvancedText(0.595, 0.213, 0.005, 0.0028, 1.0, "GMT PURGE", 255, 255, 255, 255, 1, 0)
    ...
    f("F6 TO OPEN LEADERBOARD", "", 0)
end
if tGMT.isPurge() then
    tGMT.createThreadOnTick(u)
end
...
AddEventHandler("GMT:gotTopFraggers",function(x)
    b = x
end)
RegisterNetEvent("GMT:incrementPurgeKills")
AddEventHandler("GMT:incrementPurgeKills",function()
    if b[12] and b[12][2] then
        b[12][2] = b[12][2] + 1
    else
        b[12] = {[1] = "test", 1}
