RMenu.Add("nhs","main",RageUI.CreateMenu("NHS", "Status: ~b~Available", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight()))
RMenu.Add("nhs","equipment",RageUI.CreateSubMenu(RMenu:Get("nhs", "main"),"Equipment","Status: ~b~Available",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
RMenu.Add("nhs","observations",RageUI.CreateSubMenu(RMenu:Get("nhs", "main"),"Observations","Status: ~b~Available",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
RMenu.Add("nhs","lifepak",RageUI.CreateSubMenu(RMenu:Get("nhs", "main"),"Observations","Status: ~b~Available",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
RMenu.Add("nhs","objects",RageUI.CreateSubMenu(RMenu:Get("nhs", "main"),"Objects","Status: ~b~Available",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
RegisterKeyMapping("nhs", "NHS Menu", "keyboard", "U")
TriggerEvent("chat:addSuggestion", "/nhs", "Toggle the NHS Menu")
RegisterNetEvent("GMT:beginRevive",function(a, b, c, d)
    print("nuser_id", b)
...
RegisterNetEvent("GMT:attachLifepak",function(a, b, c, d)
...
function carryLifePak()
    ...
    f.active = true
    local l = tGMT.loadModel("prop_lifepak")
...
RegisterNetEvent("GMT:clientPlayNhsSound",function(x, y)
    ...
    if globalNHSOnDuty or globalLFBOnDuty then
        ...
        if E ~= GetHashKey("WEAPON_UNARMED") then
            if not table.has(B, E) then
                tGMT.setWeapon(D, "WEAPON_UNARMED", true)
            end
        end
    end
end
tGMT.createThreadOnTick(C)

local K = false
RegisterNetEvent("GMT:attemptCPR",function()
    K = true
    tGMT.loadAnimDict("missheistfbi3b_ig8_2")
