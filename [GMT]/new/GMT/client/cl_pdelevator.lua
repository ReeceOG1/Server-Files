...
local b = 2
RMenu.Add("gmtpdelevators","main",RageUI.CreateMenu("GMT Elevators", "Vespucci PD", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight()))
...
AddEventHandler("GMT:onClientSpawn",function(i, j)
    if j then
        ...
        for n, o in pairs(a) do
            tGMT.createArea("pdelevator_" .. n, o.coords, 1.5, 6, k, l, m)
