...
local function q(r, s, t, u, v, w, x, y, z, A)
    tGMT.DrawText(r - t / 2, s - u / 2 + 0.005, w, v, 0, 1, {x, y, z, A})
end
    ...
    while true do
        ...
        if a then
            ...
            if B ~= -1 then
                ...
                tGMT.notify("~r~Couldn't spectate, person not in your zone")
            end
        end
    end
end)
...
tGMT.createThreadOnTick(X)
function tGMT.isInSpectate()
    return a
end