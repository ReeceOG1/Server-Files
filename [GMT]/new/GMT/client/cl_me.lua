...
RegisterNetEvent("GMT:sendLocalChat",function(H, I, J)
    ...
    if K ~= -1 then
        ...
        elseif #(GetEntityCoords(tGMT.getPlayerPed()) - GetEntityCoords(GetPlayerPed(K))) < 7.01 and HasEntityClearLosToEntity(tGMT.getPlayerPed(), GetPlayerPed(K), 17) == 1 then
            if c then
                TriggerEvent("chatMessage", "", {255, 0, 0}, " ^6 me | " .. I .. "  " .. "^6  " .. J)
            end
