                            ...
                            if not b(vehicle) then
                                ...
                                if k(vehicle, l) then
                                    if t <= 1 then
                                        ...
                                        while z and j do
                                            ...
                                            if IsDisabledControlPressed(0, 177) then
                                                if GetVehicleDoorLockStatus(r) <= 1 then
                                                    ...
                                                    tGMT.notify("Vehicle is locked, cannot get in boot.")
                                                end
                                            end
                                        ...
                                        tGMT.notify("Vehicle is locked, cannot get out of boot.")
                                    end
                                else
                                    tGMT.notify("You and the vehicle must remain stationary to get in.")
                                end
                            else
                                tGMT.notify("Someone is already in this boot.")
                            end
                        end
                    else
                        ClearHelp(true)
