...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~b~Admin Menu", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "players", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "closeplayers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "staffmembers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchoptions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Search Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "functions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Functions Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "devfunctions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Dev Functions Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "communitypot", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", E..'Community Pot',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "moneymenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", E..'Money Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "submenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Admin Player Interaction Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchname", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchtempid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchpermid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchhistory", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "notespreviewban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Player Notes',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "banselection", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "notespreviewban"), "", E..'Ban Menu ~w~- ~o~[Tab] to search bans',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "generatedban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "banselection"), "", E..'Ban Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "notesub", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Player Notes',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "groups", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "submenu"), "", E..'Admin Groups Menu ~w~- ~o~[Tab] to search groups',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "addgroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", E..'Admin Groups Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "removegroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", E..'Admin Groups Menu',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
                    ...
                    if Selected then
                        if tonumber(SelectedPlayer[2]) ~= GetPlayerServerId(PlayerId()) then
                            if not tGMT.isInSpectate() then
                                ...
                                tGMT.notify("You are already spectating a player.")
                            end
                        else
                            tGMT.notify("You cannot spectate yourself.")
                        end
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
...
RegisterNetEvent("GMT:gotCommunityPotAmount",function(d)
