...
Citizen.CreateThread(function()
    tGMT.createDynamicPed(a.ped.modelHash,a.ped.position,215.0,true,a.ped.animDict,a.ped.animName,30,false,false)
    tGMT.addBlip(a.ped.position.x, a.ped.position.y, a.ped.position.z, 357, 81, "Vehicle Impound", 0.8, false)
    ...
    tGMT.createArea("vehicle_impound", a.ped.position, 3.0, 6, d, e, f, {})
