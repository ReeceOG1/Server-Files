RMenu.Add('SettingsMenu', 'MainMenu', RageUI.CreateMenu("", "~b~Settings Menu", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_settingsui","gmt_settingsui")) 
RMenu.Add("SettingsMenu", "graphicpresets", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "MainMenu"), "", '~b~Graphics Presets',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "changediscord", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "MainMenu"), "", '~b~Link Discord',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "killeffects", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "MainMenu"), "", '~b~Kill Effects',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "bloodeffects", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "MainMenu"), "", '~b~Blood Effects',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "weaponswhitelist", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "MainMenu"), "", '~b~Custom Weapons Owned',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "generateaccesscode", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "weaponswhitelist"), "", '~b~Generate Access Code',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
RMenu.Add("SettingsMenu", "viewwhitelisted", RageUI.CreateSubMenu(RMenu:Get("SettingsMenu", "generateaccesscode"), "", '~b~View Whilelisted Users',tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
...
Citizen.CreateThread(function()
    local f = GetResourceKvpString("gmt_diagonalweapons") or "false"
    if f == "false" then
        b = false
    ...
    local g = GetResourceKvpString("gmt_frontars") or "false"
    if g == "false" then
        c = false
    ...
    local h = GetResourceKvpString("gmt_hitmarkersounds") or "false"
    if h == "false" then
        d = false
    ...
    local m = GetResourceKvpString("gmt_hideeventannouncement") or "false"
    if m == "false" then
        g = false
    else
        g = true
    end
    local n = GetResourceKvpString("gmt_healthpercentage") or "false"
    if n == "false" then
        z0 = false
    else
        z0 = true
...
function tGMT.setDiagonalWeaponSetting(i)
    SetResourceKvp("gmt_diagonalweapons", tostring(i))
end
function tGMT.setFrontARSetting(i)
    SetResourceKvp("gmt_frontars", tostring(i))
end
function tGMT.setHitMarkerSetting(i)
    SetResourceKvp("gmt_hitmarkersounds", tostring(i))
end
function tGMT.setCODHitMarkerSetting(i)
    SetResourceKvp("gmt_codhitmarkersounds", tostring(i))
end
function tGMT.setKillListSetting(u)
    SetResourceKvp("gmt_killlistsetting", tostring(u))
end
function tGMT.setOldKillfeed(u)
    SetResourceKvp("gmt_oldkillfeed", tostring(u))
end
function tGMT.setDamageIndicator(G)
    SetResourceKvp("gmt_damageindicator", tostring(G))
end
function tGMT.setDamageIndicatorColour(G)
    SetResourceKvp("gmt_damageindicatorcolour", tostring(G))
end
function tGMT.setReducedChatOpacity(A)
    SetResourceKvp("gmt_reducedchatopacity", tostring(A))
end
function tGMT.setHideEventAnnouncementFlag(p)
    SetResourceKvp("gmt_hideeventannouncement", tostring(p))
end
function tGMT.getHideEventAnnouncementFlag()
    return g
end
function tGMT.setShowHealthPercentageFlag(z0)
    SetResourceKvp("gmt_healthpercentage", tostring(z0))
end
function tGMT.setFlashlightNotAimingFlag(v)
    SetFlashLightKeepOnWhileMoving(v)
    i = v
    SetResourceKvp("gmt_flashlightnotaiming", tostring(v))
end
...
local r
local s
RegisterNetEvent("GMT:gotCustomWeaponsOwned",function(t)
    print("gotCustomWeaponsOwned", dump(t))
    o = t
end)
RegisterNetEvent("GMT:generatedAccessCode",function(u)
    print("got accessCode", u)
    r = u
end)
RegisterNetEvent("GMT:getWhitelistedUsers",function(v)
    s = v
end)
local w = {}
...
local function G(y, z, H)
    ...
    SetResourceKvp("gmt_graphic_presets", I)
end
local J = {
    "0%",
    "5%",
...
local function U()
    ...
    SetResourceKvp("gmt_kill_effects", V)
end
local W = {head = 1, body = 1, arms = 1, legs = 1}
local function X()
    local Y = json.encode(W)
    SetResourceKvp("gmt_blood_effects", Y)
end
Citizen.CreateThread(function()
    Citizen.Wait(1000)
    local I = GetResourceKvpString("gmt_graphic_presets")
    if I and I ~= "" then
        w = json.decode(I) or {}
    end
    ...
    local V = GetResourceKvpString("gmt_kill_effects")
    if V and V ~= "" then
    ...
    local Y = GetResourceKvpString("gmt_blood_effects")
    if Y and Y ~= "" then
    ...
    if RageUI.Visible(RMenu:Get('SettingsMenu', 'MainMenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            local function a4()
                TriggerEvent("GMT:setDiagonalWeapons")
                b = true
                tGMT.setDiagonalWeaponSetting(b)
            end
            local function a5()
                TriggerEvent("GMT:setVerticalWeapons")
                b = false
            ...
            local function a4()
                TriggerEvent("GMT:hsSoundsOn")
                d = true
                tGMT.setHitMarkerSetting(d)
                tGMT.notify("~y~Experimental Headshot sounds now set to " .. tostring(d))
            end
            local function a5()
                TriggerEvent("GMT:hsSoundsOff")
                d = false
            ...
            RageUI.Checkbox("Streetnames","",tGMT.isStreetnamesEnabled(),{RightBadge = RageUI.CheckboxStyle.Car},function(a0, a2, a1, a6)
            end,
            function()
            ...
            RageUI.Checkbox("Compass","",tGMT.isCompassEnabled(),{RightBadge = RageUI.CheckboxStyle.Car},function(a0, a2, a1, a6)
            end,
            function()
            ...
            RageUI.Checkbox("Hide Event Announcements","Hides the big scaleform from displaying across your screen, will still announce in chat.",g,{},function()
                ...
                g = true
                tGMT.setHideEventAnnouncementFlag(true)
            end,function()
                g = false
                tGMT.setHideEventAnnouncementFlag(false)
            end)
            ...
            RageUI.ButtonWithStyle("Inventory Colour","Set inventory colour with RGB values.",{RightLabel = "→→→"},true,function(ad, ae, af)
                if af then
    ...
    if RageUI.Visible(RMenu:Get('SettingsMenu', 'generateaccesscode')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
                ...
                if a2 then
                    ...
                    if tonumber(a9) then
                        ...
                        if a9 > 0 then
                            ...
                            TriggerServerEvent("GMT:generateWeaponAccessCode", q, a9)
                        end
                    end
                end
            end)
            RageUI.ButtonWithStyle("View whitelisted users","",{RightLabel = "→→→"},true,function(a0, a1, a2)
                if a2 then
                    TriggerServerEvent("GMT:requestWhitelistedUsers", q)
                end
    ...
    if RageUI.Visible(RMenu:Get('SettingsMenu', 'killeffects')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            if GetGameTimer() - T > ad + 1000 then
                tGMT.addKillEffect(PlayerPedId(), true)
                T = GetGameTimer()
            end
    ...
    if RageUI.Visible(RMenu:Get('SettingsMenu', 'bloodeffects')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.List("~y~Head",P,W.head,"Effect that displays when you hit the head.",{},true,function(a0, a1, a2, a3)
                ...
                if a2 then
                    tGMT.addBloodEffect("head", 0x796E, PlayerPedId())
                end
            end)
            RageUI.List("~y~Body",P,W.body,"Effect that displays when you hit the body.",{},true,function(a0, a1, a2, a3)
                ...
                if a2 then
                    tGMT.addBloodEffect("body", 0x0, PlayerPedId())
                end
            end)
            RageUI.List("~y~Arms",P,W.arms,"Effect that displays when you hit the arms.",{},true,function(a0, a1, a2, a3)
                ...
                if a2 then
                    tGMT.addBloodEffect("arms", 0xBB0, PlayerPedId())
                    tGMT.addBloodEffect("arms", 0x58B7, PlayerPedId())
                end
            end)
            RageUI.List("~y~Legs",P,W.legs,"Effect that displays when you hit the legs.",{},true,function(a0, a1, a2, a3)
                ...
                if a2 then
                    tGMT.addBloodEffect("legs", 0x3FCF, PlayerPedId())
                    tGMT.addBloodEffect("legs", 0xB3FE, PlayerPedId())
                end
            end)
        end)
    end
...
Citizen.CreateThread(function()
    while true do
        ...
        if not (tGMT.getStaffLevel() > 0) then
...
function tGMT.addKillEffect(au, av)
    if S.lightning then
        ForceLightningFlash()
    end
    if S.pedFlash then
    ...
    if S.particle ~= 1 and (tGMT.isPlatClub() or av) then
        Citizen.CreateThreadNow(function()
            ar(au)
        end)
    end
...
function tGMT.addBloodEffect(aw, ax, ag)
    local ay = W[aw]
    if ay > 1 then
        local as = Q[ay]
        tGMT.loadPtfx(as[1])
...
AddEventHandler("GMT:onPlayerKilledPed",function(az)
    tGMT.addKillEffect(az, false)
end)
local aA = {
    [0x0] = "body",
    [0x2E28] = "body",
...
AddEventHandler("GMT:onPlayerDamagePed",function(az)
    if not tGMT.isPlusClub() and not tGMT.isPlatClub() then
        return
    end
    ...
    if aB then
        ...
        tGMT.addBloodEffect(aE, ax, az)
    end
end)

RegisterNetEvent("GMT:gotDiscord")
AddEventHandler("GMT:gotDiscord",function()
