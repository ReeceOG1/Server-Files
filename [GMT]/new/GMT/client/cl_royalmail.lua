...
local b = 15
RegisterNetEvent("GMT:beginRoyalMailJob",function()
    a.tempVehicle = tGMT.spawnVehicle("boxville2",a.spawnVehicleVector.x,a.spawnVehicleVector.y,a.spawnVehicleVector.z,343,true,true,true)
    a.onJob = true
...
RegisterNetEvent("GMT:royalMailJobEnd",function()
...
RegisterNetEvent("GMT:royalMailReachedNextStop",function(c, d)
...
RegisterNetEvent("GMT:royalMailJobSetNextBlip",function(g)
...
AddEventHandler("GMT:onClientSpawn",function(h, i)
    if i then
        ...
        tGMT.addMarker(a.startVector.x,a.startVector.y,a.startVector.z,1.0,1.0,1.0,255,0,0,70,50,39,false,false,true)
