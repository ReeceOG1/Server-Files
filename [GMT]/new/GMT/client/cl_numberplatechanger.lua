...
local m = module("cfg/vehicles/cfg_garages")
m=m.garages

RMenu.Add('plateshop', 'main', RageUI.CreateMenu("Number Plate", "DVLA", 1350, 50))
RMenu.Add("plateshop", "ownedvehicles", RageUI.CreateSubMenu(RMenu:Get("plateshop", "main"), "Number Plate", "Owned Vehicles", 1350, 50))
RMenu.Add("plateshop", "changeplate", RageUI.CreateSubMenu(RMenu:Get("plateshop", "ownedvehicles"), "Number Plate", "Plate management", 1350, 50))
...
AddEventHandler("GMT:onClientSpawn",function(h, i)
    if i then
        ...
        local m = function(k)
            ...
            tGMT.DrawText3D(location, "Press [E] to open License Plate Management", 0.2)
        end
        tGMT.createArea("licenseplate", location, 1.5, 6, j, l, m, {})
