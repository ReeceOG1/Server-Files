...
local b=false
RMenu.Add('crosshair','main',RageUI.CreateMenu("","~b~GMT Crosshair Customisation ",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"gmt_settingsui","gmt_settingsui"))
...
function getInput(q, r)
    ...
    if GetOnscreenKeyboardResult() then
        ...
        local t = tonumber(s)
        if s ~= nil and s ~= "" and type(t) == "number" and t <= 255 and t >= 1 then
            return t
        else
            return r
        end
