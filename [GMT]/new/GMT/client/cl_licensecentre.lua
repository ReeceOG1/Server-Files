...
RMenu.Add('LicenseCentre', 'main', RageUI.CreateMenu("", "" .. "Job Centre", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_licenseui", "gmt_licenseui"))
RMenu.Add("LicenseCentre", "confirm", RageUI.CreateSubMenu(RMenu:Get('LicenseCentre', 'main',  tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight())))
...
AddEventHandler("GMT:onClientSpawn",function(p, q)
    if q then
        ...
        tGMT.createArea("licensecentre", licensecentre.location, 1.5, 6, r, t, u, {})
...
function func_licenseMenuControl()
    ...
    if a then
        ...
        DrawAdvancedText(0.595, 0.213, 0.005, 0.0028, 1.0, "GMT Licenses", 255, 255, 255, 255, 1, 0)
...
if not tGMT.isPurge() then
    tGMT.createThreadOnTick(func_licenseMenuControl)
end
RegisterNetEvent("GMT:RecievedLicenses",function(i)
    b = i
    a = true
end)
