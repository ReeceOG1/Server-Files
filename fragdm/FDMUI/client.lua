...
RegisterNetEvent("FDM:Loading", function(bool)
	if bool then
		SendNUIMessage({
			action = "loading"
		})
...
RegisterNetEvent("FDMClient:KillsDisplaying", function(bool)
	if bool then
		SendNUIMessage({
			action = "showKills",
		})
...
RegisterNetEvent("FDMClient:SetKills", function(data)
	SendNUIMessage({
		action = "setKills",
		kills = data,
	})
...
RegisterNetEvent("FDM:SetPoints", function(Data)
	Points = Data;
end)
