...
RegisterNetEvent("NOVA:EntityCleanupGun")
AddEventHandler("NOVA:EntityCleanupGun", function()
    ...
    if EntityCleanupGun then 
        ...
        tNOVA.notify("~g~Entity cleanup gun enabled.")
    else 
        tNOVA.notify("~r~Entity cleanup gun disabled.")
