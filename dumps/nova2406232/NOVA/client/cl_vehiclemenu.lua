...
local b = module("nova-cars", "cfg/garages")
...
RMenu.Add('vehicle_menu', 'main', RageUI.CreateMenu("", "Vehicle Options",1300, 100, "banners", "vehiclemenu"))
RMenu.Add('vehicle_menu','locations',RageUI.CreateSubMenu(RMenu:Get('vehicle_menu','main'),nil,"~b~LOCATIONS",nil,nil))
