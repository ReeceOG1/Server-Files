...
RMenu.Add('NOVAclothing', 'main', RageUI.CreateMenu("", "NOVA Clothing Menu",1300, 100, "banners", "cstore"))
RMenu.Add('NOVAclothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("NOVAclothing", "main")))
RMenu.Add('NOVAclothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("NOVAclothing", "main")))
RMenu.Add('NOVAclothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("NOVAclothing", "main")))
RMenu.Add('NOVAclothing', 'wardrobesub',  RageUI.CreateSubMenu(RMenu:Get("NOVAclothing", "main")))
RMenu.Add('wardrobesub', 'clothingsub',  RageUI.CreateSubMenu(RMenu:Get("NOVAclothing", "wardrobesub")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('NOVAclothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button("Clothes", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected) end, RMenu:Get("NOVAclothing", "clothingsubmenu"))
            RageUI.Button("Change Gender", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected) end, RMenu:Get("NOVAclothing", "changegendersubmenu"))
            RageUI.Button("~y~Wardrobe", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected) end, RMenu:Get("NOVAclothing", "wardrobesub"))
            RageUI.Button("Remove Props", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected) 
                if Selected then 
    ...
    if RageUI.Visible(RMenu:Get('NOVAclothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end,RMenu:Get("NOVAclothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('NOVAclothing', 'wardrobesub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('wardrobesub', 'clothingsub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end, RMenu:Get('NOVAclothing', 'wardrobesub'))
    ...
    if RageUI.Visible(RMenu:Get('NOVAclothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('NOVAclothing', 'clothingsubmenu')) then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.List("Ear Accessories", Earings.Max, Earings.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                Earings.Index = Index
                if Active then
                    SelectedOption = "ear accessories";
            ...
            RageUI.List("Shoes", Shoes.Max, Shoes.Index, nil, { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 6;
                    DrawAdvancedText(0.813, 0.597, 0.00, 0.0028, 0.4, 'Texture Index: ' .. Shoes.TextureIndex .. "/" .. GetNumberOfPedTextureVariations(PlayerPedId(), 6,  tonumber(Shoes.Index)),  255, 255, 255, 255, 6, 0)
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('NOVAclothing', 'main'), true) 
            Face.Index = GetPedDrawableVariation(ped, 0)
            Face.TextureIndex = GetPedTextureVariation(ped, 0)
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('NOVAclothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('NOVAclothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('NOVAclothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
...
RegisterCommand('yoda', function(source, args, RawCommand)
        ...
        tNOVA.setCustomization({model = "LegoYoda"})
        ExecuteCommand('storeallweapons') 
        Wait(750)
        SetEntityHealth(PlayerPedId(), 200) 
    end
...
RegisterCommand('hulk', function(source, args, RawCommand)
    ...
    tNOVA.setCustomization({model = "HULKv"})
    ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
...
RegisterCommand('minion', function(source, args, RawCommand)
    ...
    tNOVA.setCustomization({model = "MinionYellow"})
    ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
