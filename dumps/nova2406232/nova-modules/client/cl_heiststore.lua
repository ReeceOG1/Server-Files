-- local cfg = module("nova-modules", "cfg/cfg_stores")
-- local inMenu = false
...
-- RMenu.Add("NOVA:HeistShops", "main", RageUI.CreateMenu("Heist Store", "~b~Heist Store", 1350, 50))
-- RMenu.Add("NOVA:HeistShops", "sub", RageUI.CreateSubMenu(RMenu:Get("NOVA:HeistShops", "main"), "Heist Store", "~b~Confirm Purchase", 1350, 50))

-- RageUI.CreateWhile(1.0, RMenu:Get("NOVA:HeistShops", "main"), nil, function()
--     RageUI.IsVisible(RMenu:Get("NOVA:HeistShops", "main"), true, false, true, function()
...
--                     end
--                 end, RMenu:Get("NOVA:HeistShops", "sub", true))
--             end
--         end
--     end, function() 
--     end)

--     RageUI.IsVisible(RMenu:Get("NOVA:HeistShops", "sub"), true, false, true, function()
...
--                 if Selected then
--                     TriggerServerEvent("NOVA:SellHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("NOVA:HeistShops", "main", true))
--         else
...
--                 if Selected then
--                     TriggerServerEvent("NOVA:BuyHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("NOVA:HeistShops", "main", true))
--         end
...
--                 inMenu = true
--                 currentShop = k
--                 RageUI.Visible(RMenu:Get("NOVA:HeistShops", "main"), true)
--             end
--         end
