...
RMenu.Add("WHITELISTEDGANGS", "main", RageUI.CreateMenu("", "Gun Shop", 1300, 50, "banners", "gunstore"))
RMenu.Add("WHITELISTEDGANGS", "sub", RageUI.CreateSubMenu(RMenu:Get("WHITELISTEDGANGS", "main"), "", "Gun Shop", 1300, 50, "banners", "gunstore"))
