...
returnedMelee2 = {}
RMenu.Add('KnifeStoreMenu', 'main', RageUI.CreateMenu("", "~r~NOVA Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~NOVA Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "whietlistedmelees", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~NOVA Knife Store", 1300, 50, "banners", "knife"))
        ...
        RageUI.Button("Purchase Weapon Body" , "Purchase "..currentMeleeName.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash, false) then
                    ...
                    TriggerServerEvent('NOVA:BuyKnife', currentMeleeHash)
                end
            end
        end)
    end, function()
        ...
        RageUI.Button("Purchase Weapon Body" , "Purchase "..currentMeleeName1.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice1)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash1, false) then
                    ...
                    TriggerServerEvent('NOVA:BuyWLKnife', currentMeleeHash1)
                end
            end
        end)
...
AddEventHandler('NOVA:Error', function()
