...
RMenu.Add('LargeArmsMenu', 'main', RageUI.CreateMenu("", "~r~Large Arms", 1300, 50, "banners", "gunstore"))
RMenu.Add("LargeArmsMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("LargeArmsMenu", "main"), "", "~r~Large Arms Gun Store", 1300, 50, "banners", "gunstore"))
RMenu.Add("LargeArmsMenu", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("LargeArmsMenu", "main"), "", "~r~Large Arms Gun Store", 1300, 50, "banners", "gunstore"))
...
RageUI.CreateWhile(1.0, RMenu:Get('LargeArmsMenu', 'main'), nil, function()
    ...
    RageUI.IsVisible(RMenu:Get('LargeArmsMenu', 'main'), true, false, true, function()
        ...
        RageUI.Button("Level 2 Armour [50%]" , "~g~£0", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
            ...
            if Selected then
                TriggerServerEvent('NOVA:BuyArmour', 0, 50)
            end
        end)
    ...
    RageUI.IsVisible(RMenu:Get("LargeArmsMenu", "sub"), true, false, true, function()
        RageUI.Button("Purchase Weapon Body" , "Purchase "..currentGunName.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentGunPrice)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                TriggerServerEvent("NOVA:BuyGun", currentGunHash)
                end
            end
        end)
