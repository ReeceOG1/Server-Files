...
--             TriggerEvent('NOVA:PlaySound', 'alarm')
...
--     TriggerEvent('NOVA:PlaySound', 'drill')
--     statusbox1 = true
--     drill = drill+1
...
-- RegisterNetEvent('NOVA:setBankRobberyBlip')
-- AddEventHandler('NOVA:setBankRobberyBlip', function(player)
