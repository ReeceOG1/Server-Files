NOVAcfgdrugsClientT = {}
Tunnel.bindInterface("NOVA_cfgdrugs",NOVAcfgdrugsClientT)
Proxy.addInterface("NOVA_cfgdrugs",NOVAcfgdrugsClientT)
NOVAcfgdrugsServer = Tunnel.getInterface("NOVA_cfgdrugs","NOVA_cfgdrugs")
