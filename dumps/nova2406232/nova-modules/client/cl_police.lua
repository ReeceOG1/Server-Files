...
RMenu.Add('pdsmall', 'main', RageUI.CreateMenu("", "~b~NOVA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("pdsmall", "sub", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~b~NOVA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("pdsmall", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~b~NOVA Police Armoury", 1300, 50, "banners", "police"))
