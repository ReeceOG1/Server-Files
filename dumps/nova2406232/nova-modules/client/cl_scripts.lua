...
Citizen.CreateThread(function()
	AddTextEntry('FE_THDR_GTAO', 'NOVA - discord.gg/nova5m')
	AddTextEntry("PM_PANE_CFX", "NOVA")
end)
...
RegisterCommand(
    "flipcar",
    function()
        local b, c = NOVA.getPlayerVehicle()
        if b == 0 then
