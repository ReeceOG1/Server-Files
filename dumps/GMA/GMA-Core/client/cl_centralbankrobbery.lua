...
function mycb2(success, timeremaining)
	if success then
        ...
        SetTimeout(10000, function()
            TriggerEvent('gma:PlaySound', 'alarm')
...
AddEventHandler('bankofenglandrobbery:boxuse1', function()
    ...
    TriggerEvent('gma:PlaySound', 'drill')
    statusbox1 = true
    drill = drill+1
...
RegisterNetEvent('GMA:setBankRobberyBlip')
AddEventHandler('GMA:setBankRobberyBlip', function(player)
