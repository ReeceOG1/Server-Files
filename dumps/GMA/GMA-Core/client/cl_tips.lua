...
{ 
    ...
    prefix.."^4Support GMA discord.gg/GMA for some cool VIP perks!",
    prefix.."^4Support GMA discord.gg/GMA for some cool VIP perks!",
    prefix.."^4Support GMA discord.gg/GMA for some cool VIP perks!",
    prefix.."^4Support GMA discord.gg/GMA for some cool VIP perks!",
    ...
    prefix.."^4Check out our Discord for whitelisted faction applications, discord.gg/GMA",
    prefix.."^4Want to join the PD? Apply at discord.gg/GMA",
    ...
    prefix.."^4Join our discord for discussion & development news https://discord.gg/GMA",
    prefix.."^4Join our discord for discussion & development news https://discord.gg/GMA",
    prefix.."^4Join our discord for discussion & development news https://discord.gg/GMA",
    prefix.."^4Join our discord for discussion & development news https://discord.gg/GMA",
    ...
    prefix.."^4Press F1 for help on getting started, controls & rules",
    prefix.."^4Press F1 for help on getting started, controls & rules",
    prefix.."^4Join our discord to purchase custom cars & guns! https://discord.gg/GMA",
    prefix.."^4Join our discord to purchase custom cars & guns! https://discord.gg/GMA",
    prefix.."^4Join our discord to purchase custom cars & guns! https://discord.gg/GMA",
    prefix.."^4Join our discord to purchase custom cars & guns! https://discord.gg/GMA",
    prefix.."^4Join our discord to purchase custom cars & guns! https://discord.gg/GMA",
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        num = math.random(1,#GMATips)
        TriggerEvent('chatMessage',"", {255, 51, 51}, "" .. GMATips[num], "ooc")
        Wait(600000)
    end
end)
