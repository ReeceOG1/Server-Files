...
AddEventHandler("NotBoosing", function()
    ShowNotification("~r~You are not boosting GMA")
    ShowNotification("~y~You can boost our server @ disord.gg/GMA")
end)
...
AddEventHandler("SpawningNitro", function()
    ...
    if NitroCooldown == 0 then
        ...
        Citizen.CreateThread(function() 
            ...
            ShowNotification("~g~BMX Spawned Thanks for Boosting GMA!")
