...
returnedMelee2 = {}
RMenu.Add('KnifeStoreMenu', 'main', RageUI.CreateMenu("", "~r~GMA Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~GMA Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "whietlistedmelees", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~GMA Knife Store", 1300, 50, "banners", "knife"))
        ...
        RageUI.Button("Purchase Weapon Body" , "Purchase "..currentMeleeName.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash, false) then
                    ...
                    TriggerServerEvent('GMA:BuyKnife', currentMeleeHash)
                end
            end
        end)
    end, function()
        ...
        RageUI.Button("Purchase Weapon Body" , "Purchase "..currentMeleeName1.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice1)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash1, false) then
                    ...
                    TriggerServerEvent('GMA:BuyWLKnife', currentMeleeHash1)
                end
            end
        end)
...
RegisterNetEvent('GMA:Error')
AddEventHandler('GMA:Error', function()
