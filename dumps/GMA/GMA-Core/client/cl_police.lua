...
RMenu.Add('pdsmall', 'main', RageUI.CreateMenu("", "~g~GMA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("pdsmall", "sub", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~g~GMA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("pdsmall", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("pdsmall", "main"), "", "~g~GMA Police Armoury", 1300, 50, "banners", "police"))
