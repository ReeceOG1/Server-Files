local cfg = module("GMA-Veh", "cfg/cfg_speedcap")
...
legionJD = {x = 151.56065368652, y = -1039.5373535156, z = 29.367965698242}
...
local blips = {
	...
	{title="Safe Zone", colour=2, id=1, pos=vector3(legionJD.x, legionJD.y, legionJD.z),dist=27,nonRP=false,setBit=false},
...
if not purge then
	...
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
	local pos = AddBlipForRadius(151.56065368652,-1039.5373535156,29.367965698242, 27.0) -- jd green 
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
