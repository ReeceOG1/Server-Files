GMAcfgdrugsClientT = {}
Tunnel.bindInterface("GMA_cfgdrugs",GMAcfgdrugsClientT)
Proxy.addInterface("GMA_cfgdrugs",GMAcfgdrugsClientT)
GMAcfgdrugsServer = Tunnel.getInterface("GMA_cfgdrugs","GMA_cfgdrugs")
