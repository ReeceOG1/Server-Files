...
RMenu.Add("SmallArmsMenu", "main", RageUI.CreateMenu("", "~r~GMA Small Arms", 1300, 50, "banners", "small"))
RMenu.Add("SmallArmsMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "~r~GMA Small Arms", 1300, 50, "banners", "small"))
RMenu.Add("SmallArmsMenu", "whitelisted", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "~r~GMA Small Arms", 1300, 50, "banners", "small"))
