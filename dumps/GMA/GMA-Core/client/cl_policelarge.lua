...
RMenu.Add('policelarge', 'main', RageUI.CreateMenu("", "~b~GMA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "sub", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~GMA Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~GMA Police Armoury", 1300, 50, "banners", "police"))
