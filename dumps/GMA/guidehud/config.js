var config = {
  'title': '',
  'welcomeMessage':'GMA British RP',
  // Add images for the loading screen background.
  images: [
    'https://i.imgur.com/mfgbkIB.png', 'https://GMAforums.com/images/fivem/bg2.jpg', 'https://GMAforums.com/images/fivem/bg3.jpg',  
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/GMA',
  },
...
var gettingstarted = [
  'Welcome to GMA',
  'The world of GMA is pretty huge so it can be a little overwhelming at first! Here\'s a couple things you can do to get started and work you way up in the world:',
  '',
...
var generalhotkeys = [
  ...
  'Press <kbd>F5</kbd> to open the GMA Gang Menu',
