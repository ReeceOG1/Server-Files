...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("GMA:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("GMA:setHairstyle")
AddEventHandler("GMA:setHairstyle",function(hairstyle)
    if hairstyle then
...
local GMAFaceDataBlips = {
	...
	{131.97152709961,-1032.7513427734,29.552446365356},
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(GMAFaceDataBlips) do
