...
Citizen.CreateThread(function()
    TriggerServerEvent("GMA:PoliceCheckRadial")
    TriggerServerEvent("GMA:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("GMA:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("GMA:CleanCar")
AddEventHandler("GMA:CleanCar",function()
