...
RegisterNetEvent("GMA:PoliceClockedOn")
AddEventHandler("GMA:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)

-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999-- 𝘾 𝙮 𝙚#9999
rootCarMenuConfig =  {
    {
        id = "general",
...
newSubMenus = {
    ...
    --     functionName = "GMAVeh:lockcar"
    -- },
    -- ['vehmenu:repaircar'] = {
    --     title = "Repair Vehicle",
    --     icon = "#general-check-vehicle",
    --     functionName = "GMA:ComingSoon"
    -- }, 
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "GMA:LockPick2"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "GMA:CleanCar"
    },

    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'GMA:reviveRadial'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "GMA:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "GMA:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "GMA:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "GMA:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "GMA:SearchPlr"
    },
    ['general:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "GMA:PutPlrInVeh"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "GMA:TakeOutOfVehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'GMA:JailPlayer'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "GMA:UnJailPlayer"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'GMA:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'GMA:SeizeWeapons2'
    }, 
--[[     ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'GMA:SeizeWeapons'
    },  ]]
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
