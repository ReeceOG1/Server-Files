...
-- RegisterNetEvent("GMA:sendGangFunds")
-- AddEventHandler("GMA:sendGangFunds",function(funds)
--     gangfunds = funds
-- end)


-- RMenu.Add('GMAGangFunds', 'main', RageUI.CreateMenu("Gang Funds", "~b~Gang Funds", 1350, 50))
-- RageUI.CreateWhile(1.0, true, function()
--     if RageUI.Visible(RMenu:Get('GMAGangFunds', 'main')) then
...
--                     TriggerServerEvent('GMA:getGangFunds')
--                     RageUI.Visible(RMenu:Get('GMAGangFunds', 'main'), true) 
--                     inGangFunds = true
--                     currentAmmunition = k 
--                 end
--             end
...
--                 RageUI.Visible(RMenu:Get('GMAGangFunds', 'main'), false) 
--                 inGangFunds = false
