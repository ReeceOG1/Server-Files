                ...
                if IsPlayerFreeAiming(PlayerId()) then
                    ...
                    if getaimeentity ~= 0 then
                        ...
                        if entityspeed > 100 and lastentityvehicle ~= vehicleplate then
                            ...
                            TriggerServerEvent("GMA:speedGunFinePlayer", GetPlayerServerId(NetworkGetPlayerIndexFromPed(aimeentity)), entityspeed)
...
RegisterNetEvent('GMA:speedGunPlayerFined')
AddEventHandler('GMA:speedGunPlayerFined', function()
    PlaySoundFrontend(-1, "ScreenFlash", "MissionFailedSounds", 1)
    StartScreenEffect("FocusOut", 0, false)
    Wait(2000)
    StopScreenEffect("FocusOut")
