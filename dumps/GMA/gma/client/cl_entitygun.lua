...
RegisterNetEvent("GMA:EntityCleanupGun")
AddEventHandler("GMA:EntityCleanupGun", function()
    ...
    if EntityCleanupGun then 
        ...
        tGMA.notify("~g~Entity cleanup gun enabled.")
    else 
        tGMA.notify("~r~Entity cleanup gun disabled.")
