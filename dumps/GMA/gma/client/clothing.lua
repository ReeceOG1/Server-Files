...
RMenu.Add('GMAClothing', 'main', RageUI.CreateMenu("", "Clothing Store",1300, 100, "banners", "clothes"))
RMenu.Add('GMAClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("GMAClothing", "main")))
RMenu.Add('GMAClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("GMAClothing", "main")))
RMenu.Add('GMAClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("GMAClothing", "main")))
RMenu.Add('GMAClothing', 'wardrobesub',  RageUI.CreateSubMenu(RMenu:Get("GMAClothing", "main")))
RMenu.Add('wardrobesub', 'clothingsub',  RageUI.CreateSubMenu(RMenu:Get("GMAClothing", "wardrobesub")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('GMAClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button("Change your Clothes", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("GMAClothing", "clothingsubmenu"))
            RageUI.Button("Change Gender", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("GMAClothing", "changegendersubmenu"))
           -- RageUI.Button("Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("GMAClothing", "changepedmenu"))
            RageUI.Button("~y~Wardrobe", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("GMAClothing", "wardrobesub"))
    ...
    if RageUI.Visible(RMenu:Get('GMAClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end,RMenu:Get("GMAClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('GMAClothing', 'wardrobesub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('wardrobesub', 'clothingsub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                ...
                if Selected then
                    for k, v in pairs(wardrobe) do
                        if k == currentOutfit then
                            ...
                            tGMA.setCustomization(v)

                            SetTimeout(50, function()
                                SetPedArmour(PlayerPedId(), savedArmour)
                                TriggerServerEvent('GMA:changeHairStyle')
                            end)
            ...
            end, RMenu:Get('GMAClothing', 'wardrobesub'))
    ...
    if RageUI.Visible(RMenu:Get('GMAClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('GMAClothing', 'clothingsubmenu')) then
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('GMAClothing', 'main'), true) 
            Face.Index = GetPedDrawableVariation(ped, 0)
            Face.TextureIndex = GetPedTextureVariation(ped, 0)
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('GMAClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('GMAClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('GMAClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
...
RegisterCommand('yoda', function(source, args, RawCommand)
        if getUserId() == 2 then
        tGMA.setCustomization({model = "LegoYoda"})
   --     ExecuteCommand('storeallweapons') 
        Wait(750)
        SetEntityHealth(PlayerPedId(), 200) 
    end
...
RegisterCommand('hulk', function(source, args, RawCommand)
    ...
    tGMA.setCustomization({model = "HULKv"})
   -- ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
...
RegisterCommand('minion', function(source, args, RawCommand)
    ...
    tGMA.setCustomization({model = "MinionYellow"})
   -- ExecuteCommand('storeallweapons') 
    Wait(750)
    SetEntityHealth(PlayerPedId(), 200) 
end
