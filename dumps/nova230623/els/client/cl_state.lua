...
RegisterNetEvent("NOVAELS:changeStage", function(netId, stage)
...
RegisterNetEvent("NOVAELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("NOVAELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("NOVAELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("NOVAELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("NOVAELS:indicatorChange", function(netId, indicator, enabled)
