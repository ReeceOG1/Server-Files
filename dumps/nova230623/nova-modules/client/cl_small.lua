...
RMenu.Add("SmallArmsMenu", "main", RageUI.CreateMenu("", "NOVA Small Arms", 1300, 50, "banners", "gunstore"))
RMenu.Add("SmallArmsMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "NOVA Small Arms", 1300, 50, "banners", "gunstore"))
RMenu.Add("SmallArmsMenu", "whitelisted", RageUI.CreateSubMenu(RMenu:Get("SmallArmsMenu", "main"), "", "NOVA Small Arms", 1300, 50, "banners", "gunstore"))
