...
RMenu.Add('RebelMenu', 'main', RageUI.CreateMenu("", "~r~NOVA Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~NOVA Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "adrebel", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~NOVA Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "armourplate", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~NOVA Rebel", 1300, 50, "banners", "rebel"))
...
AddEventHandler("NOVA:PlaySound", function(status)
    if status == 1 then 
