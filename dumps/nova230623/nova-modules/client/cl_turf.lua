...
RegisterNetEvent('NOVA:TakenTurf')
AddEventHandler('NOVA:TakenTurf', function(isnTurf)
...
RegisterNetEvent('NOVA:OutOfZone')
AddEventHandler('NOVA:OutOfZone', function(isnTurf)
	inTurf = false

	-- TriggerEvent('chatMessage', '[NOVA Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you will receive nothing.")
...
RegisterNetEvent('NOVA:PlayerDied')
AddEventHandler('NOVA:PlayerDied', function(isnTurf)
	inTurf = false
	-- TriggerEvent('chatMessage', '[NOVA Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you died!")
...
RegisterNetEvent('NOVA:TurfComplete')
AddEventHandler('NOVA:TurfComplete', function(reward, name)
	inTurf = false
	-- TriggerEvent('chatMessage', '[NOVA Turf System]:', {255, 34, 0}, "Turf capture sucessful, you received:^2 £" .. reward)
...
Citizen.CreateThread(function()
	while true do
		...
		if inTurf then		
			...
			TriggerServerEvent('NOVA:PlayerDied', turf)

			elseif (Vdist(pos.x, pos.y, pos.z, pos2.x, pos2.y, pos2.z) > turfs[turf].radius) then
				TriggerServerEvent('NOVA:TooFar', turf)
			end
		end
