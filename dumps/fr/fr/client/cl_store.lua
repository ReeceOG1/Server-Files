...
local function a2(K)
    ...
    m = FR.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
            ...
            function()
                ...
                RageUI.ButtonWithStyle(
                    ...
                    function(X, Y, Z)
                        if Z then
                            if
                                tFR.canAnim() and FR.getPlayerCombatTimer() == 0 and FR.getPlayerVehicle() == 0 and
                                    not FR.isPlayerInRedZone() and
                                    FR.getPlayerBucket() == 0
                             then
                                a2(g)
                            else
...
local function az()
    if l then
        ...
        local vehicle, aA = FR.getPlayerVehicle()
...
RegisterNetEvent(
    "FR:storeDrawEffects",
    function()
        FR.loadPtfx("scr_xs_celebration")
        FR.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
            local a4 = FR.getPlayerCoords()
