...
local function u()
    ...
    if a then
        ...
        DrawAdvancedText(0.595, 0.213, 0.005, 0.0028, 1.0, "FR PURGE", 255, 255, 255, 255, 1, 0)
...
AddEventHandler("FR:gotTopFraggers",function(x)
    b = x
end)
RegisterNetEvent("FR:incrementPurgeKills")
AddEventHandler("FR:incrementPurgeKills",function()
    if b[12] and b[12][2] then
        b[12][2] = b[12][2] + 1
    else
        b[12] = {[1] = "test", 1}
