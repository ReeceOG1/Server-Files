RMenu.Add("frliverymenu", "main", RageUI.CreateMenu("FR Livery Menu", "~w~FR Livery Menu", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight())) 
...
RegisterCommand("liverymenu", function()
    if IsPedInAnyVehicle(GetPlayerPed(-1), false) then
        RageUI.Visible(RMenu:Get("frliverymenu", "main"), true)
    end
end)
