RegisterNetEvent("FR:announceRestart")
AddEventHandler("FR:announceRestart",function(a,b)
...
RegisterNetEvent("FR:smallAnnouncement",function(f,g,h,i)
    tFR.announceMpSmallMsg(f,g,h,i)
end)
function tFR.announceMpSmallMsg(f,g,h,i)
