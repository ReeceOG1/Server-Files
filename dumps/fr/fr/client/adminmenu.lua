FRclient = Tunnel.getInterface("FR","FR")
...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "Admin Menu", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(), "fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "players", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Interaction Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "closeplayers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Interaction Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "staffmembers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Interaction Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "searchoptions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Search Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "functions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Functions Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "devfunctions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Dev Functions Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "communitypot", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", menuColour..'Community Pot',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "moneymenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", menuColour..'Money Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "submenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Admin Player Interaction Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "searchname", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "searchtempid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "searchpermid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "searchhistory", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "notespreviewban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Player Notes',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "banselection", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "notespreviewban"), "", menuColour..'Ban Menu ~w~- ~o~[Tab] to search bans',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "generatedban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "banselection"), "", menuColour..'Ban Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "notesub", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Player Notes',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "groups", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "submenu"), "", menuColour..'Admin Groups Menu ~w~- ~o~[Tab] to search groups',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "addgroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", menuColour..'Admin Groups Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
RMenu.Add("adminmenu", "removegroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", menuColour..'Admin Groups Menu',tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(),"fr_adminui","fr_adminui"))
...
RegisterNetEvent("FR:ReturnNearbyPlayers")
AddEventHandler("FR:ReturnNearbyPlayers", function(table)
    playersNearby = table
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if hoveredPlayer ~= nil then
            local playerCoords = GetEntityCoords(tFR.getPlayerPed())
            if tFR.isInSpectate() then
                playerCoords = GetFinalRenderedCamCoord()
            end
            TriggerServerEvent("FR:GetNearbyPlayers", playerCoords, 250)
            Citizen.Wait(1000)
        end
    end
end)
...
RegisterNetEvent("FR:gotCommunityPotAmount")
AddEventHandler("FR:gotCommunityPotAmount", function(d)
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'players')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            for k, v in pairs(players) do
                if not tFR.isUserHidden(v[3]) then
                    RageUI.ButtonWithStyle(v[1] .." ["..v[2].."]", v[1] .. " ("..v[4].." hours) PermID: " .. v[3] .. " TempID: " .. v[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            SelectedPerm = v[3]
                            TriggerServerEvent("FR:CheckPov",v[3])
                        end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
                ...
                RageUI.ButtonWithStyle("Offline Ban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        tFR.clientPrompt("Perm ID:","",function(a)
                            ...
                            TriggerServerEvent('FR:getNotes', banningPermID)
                        end)
                    end
            ...
            if tFR.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Unban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:Unban")
                    end
                end)
            end
            if tFR.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Spawn Taxi", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local A = GetEntityCoords(tFR.getPlayerPed())
                        tFR.spawnVehicle("taxi",A.x,A.y,A.z,GetEntityHeading(tFR.getPlayerPed()),true,true,true)
                    end
                end)
            end
            if tFR.getStaffLevel() >= 5 then
                    ...
                    if Selected then
                        ...
                        for E, S in pairs(GetActivePlayers()) do
                            ...
                            if T ~= -1 and M ~= 0 then
                                ...
                                if #(D - U) < 50.0 then
                                    local V = tFR.clientGetUserIdFromSource(T)
                                    if V > 0 then
                                        TriggerServerEvent('FR:RevivePlayer', GetPlayerServerId(PlayerId()), V, true)
                                    end
                                end
                            end
                        end
                ...
                RageUI.ButtonWithStyle("Remove Warning","",{RightLabel="→→→"},true,function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if (GetOnscreenKeyboardResult()) then
                            ...
                            if result then 
                                TriggerServerEvent('FR:RemoveWarning', result)
                            end
                        end
                    end
                end)
            ...
            if tFR.getStaffLevel() >= 6 then
                ...
                RageUI.ButtonWithStyle("Toggle Blips", P, {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        tFR.staffBlips(not tFR.hasStaffBlips())
                    end
                end)
                RageUI.ButtonWithStyle("Community Pot Menu","",{RightLabel="→→→"},true,function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent("FR:getCommunityPotAmount")
                    end
            ...
            if tFR.getStaffLevel() >= 10 then
                ...
                RageUI.ButtonWithStyle("Add Car", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('FR:AddCar')
                    end
                end, RMenu:Get('adminmenu', 'functions'))
                RageUI.Checkbox("Set Globally Hidden","",tFR.isLocalPlayerHidden(),{},function()
                end,function()
                    TriggerServerEvent("FR:setUserHidden", true)
                end,function()
                    TriggerServerEvent("FR:setUserHidden", false)
                end)
            end
        end)
    end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if a10 ~= nil and sn ~= nil and sc ~= nil and sb ~= nil and sw ~= nil and sch ~= nil then
                ...
                RageUI.ButtonWithStyle("Bank Balance ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('FR:ManagePlayerBank',a10,j,"Increase")
                            else
                ...
                RageUI.ButtonWithStyle("Bank Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('FR:ManagePlayerBank',a10,j,"Decrease")
                            else
                                tFR.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Cash Balance ~g~+~w~",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('FR:ManagePlayerCash',a10,l,"Increase")
                            else
                                tFR.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Cash Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('FR:ManagePlayerCash',a10,l,"Decrease")
                            else
                                tFR.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('FR:ManagePlayerChips',a10,l,"Increase")
                            else
                                tFR.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tFR.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('FR:ManagePlayerChips',a10,l,"Decrease")
                            else
                                tFR.notify("~r~Invalid Amount")
                            end
                        end)
            ...
            RageUI.ButtonWithStyle("Choose PermID",nil, { RightLabel = "→→→" }, true, function(w,x,y)
                if y then
                    tFR.clientPrompt("PermID:","",function(j)
                        if tonumber(j) then
                            a10 = tonumber(j)
                            tFR.notify("~g~PermID Set To "..j)
                            TriggerServerEvent('FR:getUserinformation',a10)
                        else
                            tFR.notify("~r~Invalid PermID")
                            a10 = nil
                        end
                    end)
                end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
         --   print(communityPot) Used for debugging
            ...
            RageUI.ButtonWithStyle("Deposit","",{RightLabel="→→→"},true,function(e,f,g)
                if g then 
                    tFR.clientPrompt("Enter Amount:","",function(d)
                        if tonumber(d)then 
                            TriggerServerEvent("FR:tryDepositCommunityPot",d)
                        else 
                            tFR.notify("~r~Invalid amount.")
                        end 
                    end)
            ...
            RageUI.ButtonWithStyle("Withdraw","",{RightLabel="→→→"},true,function(e,f,g)
                if g then 
                    tFR.clientPrompt("Enter Amount:","",function(d)
                        if tonumber(d)then 
                            TriggerServerEvent("FR:tryWithdrawCommunityPot",d)
                        else 
                            tFR.notify("~r~Invalid amount.")
                        end 
                    end)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchpermid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchforPermID = tFR.KeyboardInput("Enter Perm ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchtempid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchid = tFR.KeyboardInput("Enter Temp ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchname')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                SearchName = tFR.KeyboardInput("Enter Name", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'submenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            hoveredPlayer = nil
            if tFR.isUserHidden(SelectedPlayer[3]) then
            ...
            if tFR.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Player Notes", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('FR:getNotes', SelectedPlayer[3])
                    end
                ...
                RageUI.ButtonWithStyle("Kick Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('FR:KickPlayer', uid, SelectedPlayer[3], SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tFR.getStaffLevel() >= 2 then
                ...
                RageUI.ButtonWithStyle("Spectate Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        if tonumber(SelectedPlayer[2]) ~= GetPlayerServerId(PlayerId()) then
                            if not tFR.isInSpectate() then
                                inRedZone = false
                                TriggerServerEvent("FR:spectatePlayer", SelectedPlayer[3])
                                inSpectatorAdminMode = true
                                RageUI.Text({message = string.format("Press [E] to stop spectating.")})
                            else
                                tFR.notify("You are already spectating a player.")
                            end
                        else
                            tFR.notify("You cannot spectate yourself.")
                        end
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tFR.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Revive", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('FR:RevivePlayer', uid, SelectedPlayer[3])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tFR.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Teleport to Player", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('FR:TeleportToPlayer', newSource, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Player to Me", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('FR:BringPlayer', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent("FR:Teleport2AdminIsland", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Back from Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:TeleportBackFromAdminZone", SelectedPlayer[2], savedCoordsBeforeAdminZone)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Legion", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:Teleport2Legion", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Freeze", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('FR:FreezeSV', uid, SelectedPlayer[2], isFrozen)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tFR.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Slap Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('FR:SlapPlayer', uid, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Force Clock Off", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('FR:ForceClockOff', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tFR.getStaffLevel() >= 1 then
            ...
            if tFR.getStaffLevel() >= 2 then
                RageUI.ButtonWithStyle("Take Screenshot", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('FR:RequestScreenshot', uid , SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.Button("Take Video", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], requestedVideo and {RightLabel = ""} or {RightLabel = "→→→"}, not requestedVideo, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('FR:RequestVideo', uid, SelectedPlayer[2])
                        requestedVideo = true
            ...
            if tFR.getStaffLevel() >= 6 then
                RageUI.ButtonWithStyle("Request Account Info", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:requestAccountInfosv", SelectedPlayer[3])
                    end
                end,RMenu:Get("adminmenu", "submenu"))
                RageUI.ButtonWithStyle("See Groups", --[["~r~This is moderator+ ~w~Name: " ..]] SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:GetGroups", SelectedPlayer[3])
                        tt=''
                    end
                end,RMenu:Get("adminmenu", "groups"))
            end
            if tFR.getStaffLevel() >= 12 then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tFR.getStaffLevel() >= 2 then
                if IsControlJustPressed(0, 37) then
                    tFR.clientPrompt("Search for: ","",function(O)
                        if O ~= "" then
                            o = string.lower(O)
                        else
                            o = nil
                ...
                RageUI.ButtonWithStyle("Confirm Ban", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("FR:GenerateBan", banningPermID, selectedbans)
                    end
                ...
                if next(selectedbans) then
                    if BanMessage == "N/A" then
                        ...
                        RageUI.ButtonWithStyle("Confirm", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                TriggerServerEvent("FR:BanPlayer", banningPermID, Duration, BanMessage, BanPoints)
                            end
                        end)
                    end
                else
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            if tFR.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Add To Notes:", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tFR.clientPrompt("Add To Notes: ","",function(a7)
                            if a7 ~= "" then
                                if #noteslist ~= 0 then
                                    noteslist[#noteslist + 1] = {id = #noteslist + 1, note = a7, author = tFR.getUserId()}
                                else
                                    noteslist = {{id = 1, note = a7, author = tFR.getUserId()}}
                                end
                                TriggerServerEvent("FR:updatePlayerNotes", SelectedPlayer[3], noteslist)
                            end
                        end)
                    end
                end)
                RageUI.ButtonWithStyle("Remove Note", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tFR.clientPrompt("Type the ID of the note","",function(a7)
                            if a7 ~= "" then
                                a7 = tonumber(a7)
                                local a8 = {}
                                local a9 = false
                                ...
                                if a9 == true then
                                    ...
                                    TriggerServerEvent("FR:updatePlayerNotes", SelectedPlayer[3], a8)
                                end
                            end
                        end)
                    end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'groups')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tFR.getStaffLevel() >= 7 then
                if IsControlJustPressed(0, 37) then
                    tFR.clientPrompt("Search for: ","",function(S)
                        tt=string.lower(S)
                    end)
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'addgroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Add this group to user", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("FR:AddGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
        end)
    end
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Remove user from group", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("FR:RemoveGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups')) 
        end)
    end
...
RegisterCommand("cleanup", function()
    TriggerServerEvent('FR:CleanAll')
end)

RegisterNetEvent('FR:SlapPlayer')
AddEventHandler('FR:SlapPlayer', function()
    SetEntityHealth(PlayerPedId(), 0)
end)


frozen = false
RegisterNetEvent("FR:Freeze",function()
    ...
    if not frozen then
        ...
        frozen = true
        while frozen do
            tFR.setWeapon(Q, "WEAPON_UNARMED", true)
            Wait(0)
        end
    else
...
RegisterNetEvent("FR:sendNotes",function(a7)
    a7 = json.decode(a7)
    if a7 == nil then
        noteslist = {}
    else
...
RegisterNetEvent('FR:ReturnPov')
AddEventHandler('FR:ReturnPov', function(pov)
    povlist = pov
end)

RegisterNetEvent("FR:GotGroups")
AddEventHandler("FR:GotGroups",function(gotGroups)
    searchPlayerGroups = gotGroups
end)

RegisterNetEvent("FR:getPlayersInfo")
AddEventHandler("FR:getPlayersInfo", function(BB, preasons)
    players = BB
    banreasons = preasons
    RageUI.Visible(RMenu:Get("adminmenu", "main"), not RageUI.Visible(RMenu:Get("adminmenu", "main")))
end)

RegisterNetEvent("FR:RecieveBanPlayerData")
AddEventHandler("FR:RecieveBanPlayerData",function(BanDuration, CollectedBanMessage, SepMSG, points)
...
RegisterNetEvent("FR:receivedUserInformation")
AddEventHandler("FR:receivedUserInformation", function(us,un,ub,uw,uc)
    if us == nil or un == nil or ub == nil or uw == nil or uc == nil then
        a10 = nil
        tFR.notify("~r~Player does not exist.")
        return
    end
    sc=us
    sn=un
...
RegisterNetEvent('FR:OpenAdminMenu')
AddEventHandler('FR:OpenAdminMenu', function(admin)
    if admin then
        TriggerServerEvent('FR:GetPlayerData')
        TriggerServerEvent("FR:GetNearbyPlayerData")
        TriggerServerEvent("FR:getAdminLevel")
    end
end)
...
function func_checkSpectatorMode()
    if inSpectatorAdminMode then
        if IsControlJustPressed(0, 51) then
            ...
            TriggerServerEvent("FR:stopSpectatePlayer")
        end
    end
end
tFR.createThreadOnTick(func_checkSpectatorMode)


RegisterNetEvent("FR:takeClientScreenshotAndUpload",function(url)
    local url = url -- need a custom uploader whenever
    exports["screenshot-basic"]:requestScreenshotUpload(url,"files[]",function(ab)
    end)
end)

RegisterNetEvent("FR:takeClientVideoAndUpload",function(url)
    local url = url  -- need a custom uploader whenever
...
local function ao()
    ...
    if GetGameTimer() - an > 60000 then
        TriggerServerEvent("FR:acType16")
    end
end
AddEventHandler("FR:onClientSpawn",function(C, D)
    if D then
        an = GetGameTimer()
        while true do
            ao()
...
local aK = false
RegisterNetEvent("FR:adminTicketFeedback",function(aL)
    local aM, aN = tFR.getPlayerVehicle()
    if aM ~= 0 and aN and GetEntitySpeed(aM) > 25.0 or tFR.getPlayerCombatTimer() > 0 then
        return
    end
    if aK then
        return
    ...
    if aO then
        local aP = false
        tFR.clientPrompt("Attached Message","",function(aQ)
            TriggerServerEvent("FR:adminTicketFeedback", aL, aO, aQ)
            aP = true
        end)
        while not aP do
            for a1 = 0, 6 do
        ...
        TriggerServerEvent("FR:adminTicketNoFeedback", aL)
    end
    tFR.showUI()
