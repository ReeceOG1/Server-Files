...
local d
RegisterNetEvent("FR:crateDrop",function(e, f, g)
    ...
    DecorSetInt(a[f].crate, "FRACVeh", 955)
    ...
    DecorSetInt(a[f].parachute, "FRACVeh", 955)
...
RegisterNetEvent("FR:removeLootcrate",function(f)
    if a[f] then
...
RegisterNetEvent("FR:addCrateDropRedzone",function(f, e)
    tFR.loadModel("xs_prop_arena_crate_01a")
    a[f] = {}
...
RegisterNetEvent("FR:removeCrateRedzone",function()
    SetTimeout(300000,function()
        RemoveBlip(radiusBlip)
    end)
end)