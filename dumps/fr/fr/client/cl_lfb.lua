...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight(),"fr_jobselectorui", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(), "fr_jobselectorui", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tFR.getRageUIMenuWidth(),tFR.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tFR.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tFR.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tFR.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("FR:updateFireOptions", l, n, m)
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("FR:stopAllFires")
--                         end
--                     end
--                 )
--             end,
...
--                             TriggerServerEvent("FR:updateFireTableServer", s, u, false, false, true)
--                         end
--                     end
--                 )
--             end,
...
--     end
-- )
-- TriggerServerEvent("FR:receiveLFBTablesServer")
-- local v = {}
-- local w = {}
-- local x = {}
-- local y = {}
...
--     return tFR.generateUUID("fire", 20, "alphanumeric")
-- end
-- RegisterNetEvent("FR:startFireMenu",function(F, G, H)
--     RageUI.ActuallyCloseAll()
--     RageUI.Visible(RMenu:Get("lfb", "tools"), false)
--     RageUI.Visible(RMenu:Get("lfb", "main"), false)
--     RageUI.Visible(RMenu:Get("lfb", "water"), false)
...
-- RegisterNetEvent("FR:receiveLFBTables",function(I, J, K, L, M, N, O, P, Q)
--     v = I
--     w = J
--     x = K
--     y = L
...
-- RegisterNetEvent("FR:updateFireTable",function(R, S, T, U)
--     if T then
...
--         tFR.loadPtfx(E[f[v[R].type].smokeType].dict)
...
-- }
-- RegisterNetEvent("FR:updateSupplyLineTable",function(R, S, T)
--     if T then
--         w[R] = nil
--         return
--     end
...
--     local a4 = tFR.getPlayerPed()
--     local ae = tFR.getPlayerVehicle()
--     if ae ~= 0 then
--         tFR.notify("Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tFR.notify("Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                         Wait(0)
--                     end
--                     TriggerServerEvent("FR:createLFBPropLog", "Supply Line", GetEntityCoords(aj, true))
...
--                     w[af] = {af, al, t}
--                     TriggerServerEvent("FR:updateSupplyLineTable", af, w[af], false)
--                     SetModelAsNoLongerNeeded(a2)
--                     tFR.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tFR.notify("Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
--                 TriggerServerEvent("FR:updateSupplyLineTable", af, w[af], true)
--                 TriggerServerEvent("FR:lfbDeleteSupplyLine", w[af][2])
--                 TriggerServerEvent("FR:removeVehicleStablisers", af)
--                 w[af] = nil
--                 tFR.notify("~g~Success~w~: Supply line removed")
--             else
--                 tFR.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tFR.notify("Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
-- local ap = false
-- RegisterNetEvent("FR:hoseUpdate",function(aq, ar, T)
--     if T then
--         if an[aq] ~= nil then
--             an[aq][3] = false
--             if an[aq][4] ~= nil then
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tFR.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tFR.notify("Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tFR.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tFR.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tFR.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
--         tFR.loadPtfx("core")
...
-- function handleHose()
--     local a4 = tFR.getPlayerPed()
--     local aq = tFR.getNetId(a4, "handleHose()")
--     TriggerServerEvent("FR:hoseUpdateServer", aq, 0.0, false)
--     ap = true
--     while ap do
--         DisableControlAction(0, 24, true)
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tFR.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tFR.getPlayerId()) or not X and _ < 1 then
--             ap = false
--             TriggerServerEvent("FR:hoseUpdateServer", aq, 0.0, true)
--         end
--         Wait(0)
--     end
-- end
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tFR.getPlayerPed(), 0.0, 3.0, 0.5)
--             if #(a6 - i.coords) < 7.0 then
--                 local av = math.random(1, f[i.type].chance)
--                 if av == 1 then
--                     local H = i.size * 0.92
--                     if H < 0.5 then
--                         TriggerServerEvent("FR:updateFireTableServer", h, v[h], true, false)
--                         Wait(5000)
--                     else
--                         v[h].size = H
--                         TriggerServerEvent("FR:updateFireTableServer", h, v[h], false, true)
--                         Wait(5000)
--                     end
--                     break
--                 end
...
--     end
-- end
-- RegisterNetEvent("FR:updateMonitorsTable",function(R, S, T)
--     if T then
--         x[R] = nil
--         return
--     end
...
-- RegisterNetEvent("FR:toggleWaterClient",function(R)
--     if x[R] ~= nil then
--         x[R][4] = not x[R][4]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("FR:createLFBPropLog", "Water Monitor", GetEntityCoords(aj, true))
...
--         TriggerServerEvent("FR:updateMonitorsTable", al, x[al], false)
--         SetModelAsNoLongerNeeded(ax)
--         tFR.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tFR.notify("Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tFR.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("FR:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tFR.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tFR.notify("Error~w~: No water monitor found")
--         end
--     end
-- end
-- RegisterNetEvent("FR:adjustPitchClient",function(R, az)
--     if aw[R] ~= nil and aw[R].handle ~= nil and DoesParticleFxLoopedExist(aw[R].handle) then
--         local t = x[R][2]
--         StopParticleFxLooped(aw[R].handle, false)
--         StopParticleFxLooped(aw[R].handle2, false)
...
--                                 end
--                                 if az ~= 0.0 then
--                                     TriggerServerEvent("FR:adjustPitchServer", h, az)
--                                     Wait(1000)
--                                 end
--                                 DisableControlAction(0, 38, true)
--                                 if IsDisabledControlPressed(0, 38) then
--                                     pressed = true
--                                     TriggerServerEvent("FR:toggleWaterServer", h)
--                                     tFR.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tFR.notify("Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tFR.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tFR.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tFR.notify("Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tFR.notify("Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     end
-- end
-- tFR.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
-- RegisterNetEvent("FR:toggleWaterTents",function(R)
--     if y[R] ~= nil then
--         y[R][8] = not y[R][8]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("FR:createLFBPropLog", "Decontamination Tent", GetEntityCoords(aj, true))
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         SetEntityHeading(aj, GetEntityHeading(a4))
...
--         TriggerServerEvent("FR:updateTentsTable", al, y[al], false)
--         SetModelAsNoLongerNeeded(aK)
--         tFR.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tFR.notify("Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tFR.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("FR:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tFR.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tFR.notify("Error~w~: No decontamination tent found")
--         end
--     end
-- end
-- RegisterNetEvent("FR:updateTentsTable",function(R, S, T)
--     if T then
--         y[R] = nil
--         return
--     end
...
--                     DisableControlAction(0, 38, true)
--                     if IsDisabledControlPressed(0, 38) then
--                         TriggerServerEvent("FR:toggleWaterTents", h)
--                         tFR.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
-- RegisterNetEvent("FR:updateCushionsTable",function(R, S, T)
--     if T then
--         z[R] = nil
--         return
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("FR:createLFBPropLog", "Rescue Cushion", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
...
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         z[al] = {al, a6}
--         TriggerServerEvent("FR:updateCushionsTable", al, z[al], false)
--         SetModelAsNoLongerNeeded(aR)
--         tFR.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             TriggerServerEvent("FR:deleteProp", z[ay][1])
--             local aj = tFR.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("FR:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tFR.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tFR.notify("Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tFR.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tFR.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tFR.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tFR.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
-- end
-- )
-- RegisterNetEvent("FR:updateStabilisersTable",function(R, S, T)
--     if T then
--         A[R] = nil
--         return
--     end
--     A[R] = S
-- end)
-- RegisterNetEvent("FR:updateFansTable",function(R, S, T)
--     if T then
--         B[R] = nil
--         return
--     end
--     B[R] = S
-- end)
-- RegisterNetEvent("FR:stopRtcParticles",function(t)
--     Wait(20 * 1000)
-- end)
...
--     if not a then
--         tFR.loadModel(aV)
--         tFR.loadAnimDict("weapons@heavy@minigun")
...
--             TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(aW))
--             DetachEntity(a4)
--             DetachEntity(aW)
--             DeleteEntity(aW)
--             ClearPedTasks(a4)
...
--                             TriggerServerEvent("FR:rtcOpenDoor", ba, ak[b7][2], tFR.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("FR:rtcOpenDoor", ba, ak[b7][2], tFR.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     )
-- end
-- RegisterNetEvent("FR:rtcOpenDoor",function(ba, ak, t, bb)
--     local ae = tFR.getObjectId(ba, "FR:rtcOpenDoor")
...
--     end
-- end)
-- RegisterNetEvent("FR:spreadersSound",function(t)
--     local bc = tFR.getPlayerCoords()
--     local V = #(t - bc)
--     if V < 15.0 then
...
--         if ad then
--             if ag then
--                 tFR.notify("Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tFR.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("FR:createLFBPropLog", "Vehicle Stablisers", GetEntityCoords(aj, true))
--                 SetEntityCollision(aj, false, true)
...
--                 A[af] = {af, al, bl}
--                 TriggerServerEvent("FR:updateStabilisersTable", af, A[af], false)
--                 SetModelAsNoLongerNeeded(bd)
--                 tFR.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tFR.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tFR.getObjectId(A[af][3], "handleStabilisers 2")
--                 TriggerServerEvent("FR:updateStabilisersTable", af, A[af], true)
--                 if DoesEntityExist(aj) then
--                     TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                     DeleteEntity(aj)
--                 end
--                 if DoesEntityExist(bg) then
--                     TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(bg))
--                     DeleteEntity(bg)
--                 end
--                 TriggerServerEvent("FR:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tFR.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tFR.notify("Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tFR.notify("Error~w~: No vehicle found")
--     end
-- end
-- RegisterNetEvent("FR:removeVehicleStablisers",function(bm)
...
--             Wait(0)
--         end
--         TriggerServerEvent("FR:createLFBPropLog", "Extractor Fan", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         B[al] = {al, a6}
--         TriggerServerEvent("FR:updateFansTable", al, B[al], false)
--         SetModelAsNoLongerNeeded(bn)
--         tFR.notify("~g~Success~w~: Fan setup")
--         TriggerServerEvent("FR:stopRtcParticles", t)
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             local aj = tFR.getObjectId(B[ay][1], "handleFan")
--             TriggerServerEvent("FR:updateFansTable", ay, B[ay], true)
--             if DoesEntityExist(aj) then
--                 TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                 DeleteEntity(aj)
--             end
--             B[ay] = nil
--             tFR.notify("~g~Success~w~: Fan removed")
--         else
--             tFR.notify("Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     end
-- end)
-- RegisterNetEvent("FR:updateJackTable",function(R, S, T)
--     if T then
--         C[R] = nil
--         return
--     end
--     C[R] = S
-- end)
-- RegisterNetEvent("FR:updateChockTable",function(R, S, T)
--     if T then
--         D[R] = nil
--         return
--     end
--     D[R] = S
-- end)
-- RegisterNetEvent("FR:toggleChockWheels",function(af)
--     local ae = tFR.getObjectId(af, "FR:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tFR.notify("Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
--                 if not br then
--                     C[af][5] = true
--                     TriggerServerEvent("FR:updateJackTable", af, C[af], false)
--                     local bs = tFR.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tFR.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tFR.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tFR.notify("Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("FR:createLFBPropLog", "Inflatable Jack", GetEntityCoords(bs, true))
...
--                 tFR.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tFR.notify("Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tFR.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tFR.getObjectId(C[af][3], "handleJack 4")
--                     TriggerServerEvent("FR:updateJackTable", af, C[af], true)
--                     if DoesEntityExist(bs) then
--                         TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                         DeleteEntity(bs)
--                     end
--                     if DoesEntityExist(bt) then
--                         TriggerServerEvent("FR:deleteProp", NetworkGetNetworkIdFromEntity(bt))
--                         DeleteEntity(bt)
--                     end
--                     TriggerServerEvent("FR:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tFR.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tFR.notify("Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tFR.notify("Error~w~: No vehicle found")
...
--     tFR.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--                 bz = 0.8
--             end
--             TriggerServerEvent("FR:lfbHandlingLifting", bm, by, bz)
--         end
...
--             TriggerServerEvent("FR:lfbLiftingFreeze", bm)
--             C[af][5] = false
--             C[af][4] = bz
--             TriggerServerEvent("FR:updateJackTable", af, C[af], false)
--             tFR.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
-- end
-- RegisterNetEvent("FR:lfbHandlingLifting",function(bm, by, bz)
...
-- end)
-- RegisterNetEvent("FR:lfbLiftingFreeze",function(bm)
...
--         if ad then
--             if ag then
--                 tFR.notify("Error~w~: This vehicle already has chocks setup")
--             else
--                 local bu = GetEntityCoords(ae)
--                 ResetVehicleWheels(ae, true)
--                 tFR.loadModel(bB)
--                 TriggerServerEvent("FR:toggleChockWheels", af)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("FR:createLFBPropLog", "Air Chocks", GetEntityCoords(bC, true))
--                 local bh = GetEntityHeading(ae)
...
--                 D[af] = {af, bK, bL, bM, bN}
--                 TriggerServerEvent("FR:updateChockTable", af, D[af], false)
--                 SetModelAsNoLongerNeeded(bB)
--                 TaskGoStraightToCoord(tFR.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tFR.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tFR.getObjectId(D[af][2], "chock1")
--                 local bD = tFR.getObjectId(D[af][3], "chock2")
--                 local bE = tFR.getObjectId(D[af][4], "chock3")
--                 local bF = tFR.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                     DeleteEntity(bF)
--                 end
--                 TriggerServerEvent("FR:updateChockTable", af, D[af], true)
--                 TriggerServerEvent("FR:removeVehicleStablisers", af)
--                 tFR.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tFR.notify("Error~w~: No car chocks found")
--             end
--         end
--     else
--         tFR.notify("Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tFR.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tFR.notify("Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tFR.getPlayerPed()
--     local t = tFR.getPlayerCoords()
--     TriggerServerEvent("FR:spawnThrowBag",t,tFR.getNetId(bR, "spawnRope(entity)"),tFR.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tFR.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("FR:spawnThrowBag",function(t, aq, bT)
--     local a4 = tFR.getPlayerPed()
--     local bv = tFR.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tFR.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tFR.getObjectId(bT, "spawnThrowBag 2")
