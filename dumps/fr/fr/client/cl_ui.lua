    ...
    while true do
        if not globalHideUi then
            if not globalHideEmergencyCallUI then
                ...
                if E then
                    tFR.DrawText(A.leftX + A.Width / 2.0,A.bottomY - 0.0075,tostring(math.floor(B * 100)) .. "%",0.175,nil,nil,m)
                end
                ...
                elseif C > 0.0 then
                    ...
                    if E then
                        tFR.DrawText(A.leftX + A.Width / 2.0,A.bottomY + 0.006,tostring(math.floor(C * 100)) .. "%",0.175,nil,nil,m)
                    end
                end
            end
        end
