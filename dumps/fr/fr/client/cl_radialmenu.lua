...
local function G(H)
    ...
    ForcePedAiAndAnimationUpdate(t, false, false)
    if not tFR.inEvent() and tFR.globalOnPoliceDuty() then
...
RegisterNetEvent("fr-ui5:globalOnPoliceDuty")
AddEventHandler(
    "fr-ui5:globalOnPoliceDuty",
    function(aK)
        f = aK
    end
)
RegisterNetEvent("fr-ui5:globalOnNHSDuty")
AddEventHandler(
    "fr-ui5:globalOnNHSDuty",
    function(aK)
        g = aK
    end
)
RegisterNetEvent(
    "fr-ui5:globalOnPrisonDuty",
    function(aL)
        h = aL
    end
)
