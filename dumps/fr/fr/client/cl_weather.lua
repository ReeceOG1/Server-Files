...
RegisterNetEvent("FR:setTime",function(f, g, h)
    tFR.setTime(f, g, h)
end)
RegisterNetEvent("FR:setWeather",function(i)
    tFR.setWeather(i)
end)
...
RegisterNetEvent("FR:startWeatherVote",function()
    j = true
...
RegisterNetEvent("FR:voteStateChange",function(D)
    m[D] = m[D] + 1
end)
