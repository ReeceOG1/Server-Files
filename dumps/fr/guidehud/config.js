var config = {
  ...
  images: [
    'https://frforums.com/images/fivem/bg1.jpg', 'https://frforums.com/images/fivem/bg2.jpg', 'https://frforums.com/images/fivem/bg3.jpg',  
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/fr5m',
  },
...
var gettingstarted = [
  'Welcome to FR',
  'The world of FR is pretty huge so it can be a little overwhelming at first! Here\'s a couple things you can do to get started and work you way up in the world:',
  '',
...
var generalhotkeys = [
  ...
  'Press <kbd>F5</kbd> to open the FR Gang Menu',
