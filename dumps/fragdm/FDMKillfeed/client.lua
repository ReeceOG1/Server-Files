...
local function HandleDeath(killerPed, victimPed, weaponHash, isMelee)
    ...
    TriggerServerEvent('FDM:Killfeed:add', killer, victim, weapon.image, noScoped, headshot, driveBy, showDist)
end
...
RegisterNetEvent('FDM:Killfeed:addCL')
AddEventHandler('FDM:Killfeed:addCL', function(killer, victim, image, noScoped, headshot, driveBy, dist)
...
if Config.enableDemo then
    ...
    RegisterCommand("customdeaths", function(s,a,r)
        ...
        TriggerServerEvent('FDM:Killfeed:add', killer, victim, "starvation", false, false, false, false)
        Wait(2000)
        TriggerServerEvent('FDM:Killfeed:add', killer, victim, "dehydration", false, false, false, false)
        Wait(2000)
        TriggerServerEvent('FDM:Killfeed:add', killer, victim, "bleeding", false, false, false, false)
    end)
    ...
    RegisterCommand("testkillfeed", function(s,a,r)
        while true do
            ...
            victim.type = "player"
            victim.sourceId = GetPlayerServerId(NetworkGetPlayerIndexFromPed(PlayerPedId()))
            TriggerServerEvent('FDM:Killfeed:add', killer, victim, "WEAPON_MUSKET", true, true, false, true)
            Wait(8000)
        end
    end)
end