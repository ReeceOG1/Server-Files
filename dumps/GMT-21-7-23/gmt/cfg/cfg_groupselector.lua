...
cfg.selectorTypes = {
    ["default"] = {
        _config = {name="Job Selector", blipid = 351, blipcolor = 47, permissions = {}, TextureDictionary = "gmt_jobselectorui",texture = "jobcentre"},
        jobs = {
            {"AA Mechanic", 0},
            {"Royal Mail Driver", 0},
            {"Bus Driver", 0},
    ...
    ["casino"] = {
        _config = {name="Casino Jobs", blipid = 351, blipcolor = 47, permissions = {"casino.whitelisted"},TextureDictionary = "gmt_jobselectorui", texture = "casinosecurity"},
        jobs = groupCfg.casinoRanks
    },
    ["police"] = {
        _config = {name="Met Police", blipid = 351, blipcolor = 38, permissions = {"cop.whitelisted"},TextureDictionary = "gmt_jobselectorui", texture = "metpd"},
        jobs = groupCfg.metPoliceRanks
    },
    ["nhs"] = {
        _config = {name="NHS Job", blipid = 351, blipcolor = 3, permissions = {"nhs.whitelisted"}, TextureDictionary = "gmt_jobselectorui", texture = "nhs"},
        jobs = groupCfg.nhsRanks
    },
    ["lfb"] = {
        _config = {name="LFB Job", blipid = 351, blipcolor = 1, permissions = {"lfb.whitelisted"}, TextureDictionary = "gmt_jobselectorui", texture = "lfb"},
        jobs = groupCfg.lfbRanks
    },
    ["hmp"] = {
        _config = {name="Prison Guard", blipid = 351, blipcolor = 1, permissions = {"prisonguard.whitelisted"}, TextureDictionary = "gmt_prisonui", texture = "gmt_prisonui"},
