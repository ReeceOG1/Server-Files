...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("gmt_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("gmt_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("gmt_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("gmt_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("gmt_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("gmt_crosshair_gap")
    ...
    local red = GetResourceKvpInt("gmt_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("gmt_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("gmt_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('gmt_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('gmt_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('gmt_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('gmt_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('gmt_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('gmt_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('gmt_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('gmt_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('gmt_crosshair_green', cfg.options.colour.green)
end
