RMenu.Add("mainmenu","cinematic",RageUI.CreateMenu("", "", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "new_editor", "r_editor_header"))
RMenu:Get("mainmenu", "cinematic"):SetSubtitle("GMT Cinematic Editor")
RMenu.Add("load_scene","cinematic",RageUI.CreateSubMenu(RMenu:Get("mainmenu", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("load_scene", "cinematic"):SetSubtitle("Load Scene")
RMenu.Add("scene_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("load_scene", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("scene_manager", "cinematic"):SetSubtitle("Scene Manager")
RMenu.Add("camera_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("scene_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("camera_manager", "cinematic"):SetSubtitle("Camera Manager")
RMenu.Add("screeneffect_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("screeneffect_manager", "cinematic"):SetSubtitle("Screen Effect Manager")
RMenu.Add("timecycle_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("timecycle_manager", "cinematic"):SetSubtitle("Timecycle Effect Manager")
RMenu.Add("shake_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("shake_manager", "cinematic"):SetSubtitle("Shake Effect Manager")
RMenu.Add("add_camera","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("add_camera", "cinematic"):SetSubtitle("Add Camera")
RMenu.Add("camera_focus_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("camera_focus_manager", "cinematic"):SetSubtitle("Camera Focus")
RMenu.Add("weather_time_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("mainmenu", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("weather_time_manager", "cinematic"):SetSubtitle("Time/Weather Manager")
RMenu.Add("dof_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"new_editor","r_editor_header"))
...
RegisterNetEvent("GMT:openCinematicMenu",function()
    a(true)
end)
function tGMT.createCinematicScene(P)
    m[P] = {}
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Scene created & saved.")
end
function tGMT.deleteCinematicScene(P)
    m[P] = nil
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Scene deleted & saved.")
end
function tGMT.createCamera(P, Q)
    ...
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Camera created & saved.")
end
function tGMT.modifyCamera(P, Q, R)
    m[P][R] = Q
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Camera modified & saved.")
end
function tGMT.deleteCamera(P, S)
    table.remove(m[P], S)
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Camera deleted & saved.")
end
function tGMT.modifyTransition(n, q, T)
    m[n][q].transition = tonumber(T)
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Transition change saved.")
end
function tGMT.modifyCameraBlending(n, q, U)
    m[n][q].blending = l[U]
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Camera Blending change saved.")
end
function tGMT.modifyScreeneffect(n, q, V)
    m[n][q].screeneffect = V
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Screeneffect change saved.")
end
function tGMT.modifyTimecycleEffect(n, q, W)
    m[n][q].timecycleEffect = W
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Timecycle Effect change saved.")
end
function tGMT.setTimecycleIntensity(n, q, f)
    m[n][q].timecycleIntensity = f
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Timecycle intensity change saved.")
end
function tGMT.modifyShakeEffect(n, q, X)
    m[n][q].shake = X
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Shake change saved.")
end
function tGMT.modifyCameraType(n, q, type)
    m[n][q].type = type
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Camera type change saved.")
end
function tGMT.addCameraFocus(n, q, Y, Z)
    m[n][q].focusType = Y
    m[n][q].focusData = Z
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~Follow player change saved.")
end
function tGMT.setCameraFov(n, q)
    m[n][q].fov = i[A]
    SetResourceKvp("gmt_scenedata", json.encode(m))
    tGMT.notify("~g~FOV change saved.")
end
                ...
                RageUI.ButtonWithStyle("Transition: " .. m[n][q].transition .. "ms","",{RightLabel = "→→→"},true,function(a1, a2, a3)
                    if a3 then
                        ...
                        if tonumber(T) then
                            ...
                            tGMT.notify("~r~Failed to change transition time.")
                        end
                    end
                end,RMenu:Get("camera_manager", "cinematic"))
                ...
                RageUI.List("Timecycle Intensity",f,e,"",{},true,function(a1, a2, a3, a8)
                    ...
                    if a8 ~= e then
                        ...
                        if m[n][q].timecycleEffect ~= "" then
                            ...
                            tGMT.setTimecycleIntensity(n, q, f[e])
                        end
                    end
                end,function()end,nil)
    ...
    if RageUI.Visible(RMenu:Get('camera_focus_manager', 'cinematic')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            RageUI.ButtonWithStyle("Coordinates","",{RightLabel = "→→→"},true,function(a1, a2, a3)
                if a3 then
                    tGMT.clientPrompt("Enter coordinates:","",function(aa)
                        local ab = {}
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if (o or p) and noclipActive and tGMT.getPlayerVehicle() ~= 0 then
            tGMT.notify("~r~You may not noclip when in a vehicle.")
            tGMT.toggleNoclip()
        end
...
Citizen.CreateThread(function()
    while true do
        local al, am = tGMT.getPlayerVehicle()
        ...
        if an ~= 0 and IsEntityAPed(an) and IsPedAPlayer(an) and not IsEntityVisible(an) then
            ...
            if ao ~= -1 then
                ...
                if ap > 0 then
                    if not tGMT.clientGetPlayerIsStaff(tGMT.clientGetUserIdFromSource(ap)) then
