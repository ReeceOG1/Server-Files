...
RMenu.Add("GMTHousing", "main", RageUI.CreateMenu("", "", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"banners","housing"))
RMenu.Add("GMTHousing", "leave", RageUI.CreateMenu("", "", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(),"banners","housing"))
