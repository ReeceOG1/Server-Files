...
RegisterNetEvent("GMT:beginDeliverooJob",function()
    ...
    b.tempVehicle = tGMT.spawnVehicle(e,b.spawnVehicleVector.x,b.spawnVehicleVector.y,b.spawnVehicleVector.z,343,true,true,true)
    b.onJob = true
    tGMT.disableCustomizationSave(b.onJob)
    ...
    tGMT.notify("~g~Deliveroo Job started, exit the restaurant and head to the first drop off.")
    while b.onJob do
...
AddEventHandler("GMT:onClientSpawn",function(m, n)
    if n then
        ...
        tGMT.createArea("deliveroo", b.startVector, 1.5, 6, o, q, r, {})
    end
end)
