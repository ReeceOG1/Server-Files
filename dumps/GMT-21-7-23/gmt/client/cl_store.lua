...
RMenu.Add(
    "store",
    "mainmenu",
    RageUI.CreateMenu("", "Inventory", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_storeui", "gmt_storeui")
)
RMenu.Add(
    "store",
    "info",
...
local function a2(K)
    ...
    m = tGMT.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
            ...
            function()
                ...
                RageUI.ButtonWithStyle(
                    ...
                    function(X, Y, Z)
                        if Z then
                            if
                                tGMT.canAnim() and tGMT.getPlayerCombatTimer() == 0 and tGMT.getPlayerVehicle() == 0 and
                                    not tGMT.isPlayerInRedZone() and
                                    tGMT.getPlayerBucket() == 0
                             then
                                a2(g)
                            else
...
RMenu.Add(
    "vehicletesting",
    "mainmenu",
    RageUI.CreateMenu("", "Main Menu", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_storeui", "store")
)
RMenu.Add(
    "vehicletesting",
    "extras",
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("BTF:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = tGMT.getPlayerVehicle()
...
function tGMT.isInStoreTesting()
    return l
end
RegisterNetEvent(
    ...
    function()
        ...
        tGMT.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
