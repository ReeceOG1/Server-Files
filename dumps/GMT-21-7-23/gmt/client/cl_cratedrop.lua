...
local d
RegisterNetEvent("GMT:crateDrop",function(e, f, g)
    ...
    DecorSetInt(a[f].crate, "GMTACVeh", 955)
    ...
    DecorSetInt(a[f].parachute, "GMTACVeh", 955)
...
RegisterNetEvent("GMT:removeLootcrate",function(f)
    if a[f] then
...
RegisterNetEvent("GMT:addCrateDropRedzone",function(f, e)
    tGMT.loadModel("xs_prop_arena_crate_01a")
    a[f] = {}
...
RegisterNetEvent("GMT:removeCrateRedzone",function()
    SetTimeout(300000,function()
        RemoveBlip(radiusBlip)
    end)
end)