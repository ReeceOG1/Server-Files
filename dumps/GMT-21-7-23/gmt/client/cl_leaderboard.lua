local a = {
    ...
    rows = {
        {"Barnsy", "~b~BLUE TEAM", "", false, 5, 2, 0, "1.4"},
        {"Foid", "~b~BLUE TEAM", "", false, 7, 5, 0, "0.5"},
        {"Ker", "~r~RED TEAM", "", false, 5, 0, 2, "0.5"},
        {"Serio", "~b~BLUE TEAM", "", false, 5, 0, 2, "1.4"},
        {"Barnsy", "~b~BLUE TEAM", "", false, 7, 5, 0, "0.5"},
        {"Foid", "~r~RED TEAM", "", false, 5, 2, 0, "0.5"},
        {"Ker", "~b~BLUE TEAM", "", false, 5, 2, 0, "1.4"},
        {"Serio", "~b~BLUE TEAM", "", false, 7, 5, 0, "0.5"},
        {"Barnsy", "~r~RED TEAM", "", false, 5, 2, 0, "0.5"}
    }
}
RegisterCommand(
    "leaderboardtest",
