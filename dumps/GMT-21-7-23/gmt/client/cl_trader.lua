...
Citizen.CreateThread(function()
    local k = tGMT.loadAnimDict("mini@strip_club@idles@bouncer@base")
...
RMenu.Add("trader","seller",RageUI.CreateMenu("GMT Trader","Sell your goods!",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),nil,nil,0,0,255,255))
...
AddEventHandler("GMT:onClientSpawn",function(p, q)
    if q then
        ...
        for y, l in pairs(b.trader) do
            tGMT.createArea("trader_" .. y, l.position, 1.5, 6, r, t, u, {traderId = y, traderName = l.type})
        end
    end
end)
