...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight(),"gmt_jobselectorui", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_jobselectorui", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tGMT.getRageUIMenuWidth(),tGMT.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tGMT.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tGMT.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tGMT.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--         tGMT.loadPtfx(E[f[v[R].type].smokeType].dict)
...
--     local a4 = tGMT.getPlayerPed()
--     local ae = tGMT.getPlayerVehicle()
--     if ae ~= 0 then
--         tGMT.notify("Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tGMT.notify("Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                     tGMT.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tGMT.notify("Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
...
--                 w[af] = nil
--                 tGMT.notify("~g~Success~w~: Supply line removed")
--             else
--                 tGMT.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tGMT.notify("Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tGMT.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tGMT.notify("Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tGMT.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tGMT.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tGMT.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
--         tGMT.loadPtfx("core")
...
-- function handleHose()
--     local a4 = tGMT.getPlayerPed()
--     local aq = tGMT.getNetId(a4, "handleHose()")
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tGMT.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tGMT.getPlayerId()) or not X and _ < 1 then
--             ap = false
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tGMT.getPlayerPed(), 0.0, 3.0, 0.5)
...
--         tGMT.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tGMT.notify("Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tGMT.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("GMT:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tGMT.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tGMT.notify("Error~w~: No water monitor found")
--         end
--     end
-- end
...
--                                     tGMT.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tGMT.notify("Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tGMT.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tGMT.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tGMT.notify("Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tGMT.notify("Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     end
-- end
-- tGMT.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
...
--         tGMT.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tGMT.notify("Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tGMT.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("GMT:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tGMT.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tGMT.notify("Error~w~: No decontamination tent found")
--         end
--     end
-- end
...
--                         tGMT.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
--         tGMT.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--             local aj = tGMT.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("GMT:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tGMT.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tGMT.notify("Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tGMT.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tGMT.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tGMT.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tGMT.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
--     if not a then
--         tGMT.loadModel(aV)
--         tGMT.loadAnimDict("weapons@heavy@minigun")
...
--                             TriggerServerEvent("GMT:rtcOpenDoor", ba, ak[b7][2], tGMT.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("GMT:rtcOpenDoor", ba, ak[b7][2], tGMT.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     local ae = tGMT.getObjectId(ba, "GMT:rtcOpenDoor")
...
--         if ad then
--             if ag then
--                 tGMT.notify("Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tGMT.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                 tGMT.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tGMT.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tGMT.getObjectId(A[af][3], "handleStabilisers 2")
...
--                 TriggerServerEvent("GMT:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tGMT.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tGMT.notify("Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tGMT.notify("Error~w~: No vehicle found")
...
--         tGMT.notify("~g~Success~w~: Fan setup")
...
--         end
--         if ai then
--             local aj = tGMT.getObjectId(B[ay][1], "handleFan")
...
--             end
--             B[ay] = nil
--             tGMT.notify("~g~Success~w~: Fan removed")
--         else
--             tGMT.notify("Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     local ae = tGMT.getObjectId(af, "GMT:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tGMT.notify("Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
...
--                     local bs = tGMT.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tGMT.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("GMT:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tGMT.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tGMT.notify("Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                 tGMT.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tGMT.notify("Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tGMT.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tGMT.getObjectId(C[af][3], "handleJack 4")
...
--                     TriggerServerEvent("GMT:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tGMT.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tGMT.notify("Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tGMT.notify("Error~w~: No vehicle found")
...
--     tGMT.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--             C[af][4] = bz
--             TriggerServerEvent("GMT:updateJackTable", af, C[af], false)
--             tGMT.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
...
--         if ad then
--             if ag then
--                 tGMT.notify("Error~w~: This vehicle already has chocks setup")
--             else
...
--                 TaskGoStraightToCoord(tGMT.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tGMT.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tGMT.getObjectId(D[af][2], "chock1")
--                 local bD = tGMT.getObjectId(D[af][3], "chock2")
--                 local bE = tGMT.getObjectId(D[af][4], "chock3")
--                 local bF = tGMT.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                 TriggerServerEvent("GMT:removeVehicleStablisers", af)
--                 tGMT.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tGMT.notify("Error~w~: No car chocks found")
--             end
--         end
--     else
--         tGMT.notify("Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tGMT.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tGMT.notify("Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tGMT.getPlayerPed()
--     local t = tGMT.getPlayerCoords()
--     TriggerServerEvent("GMT:spawnThrowBag",t,tGMT.getNetId(bR, "spawnRope(entity)"),tGMT.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tGMT.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("GMT:spawnThrowBag",function(t, aq, bT)
--     local a4 = tGMT.getPlayerPed()
--     local bv = tGMT.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tGMT.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tGMT.getObjectId(bT, "spawnThrowBag 2")
