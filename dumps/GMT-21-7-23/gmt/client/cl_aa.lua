RMenu.Add('AAMenu', 'main', RageUI.CreateMenu("","~y~AA ~w~Menu",tGMT.getRageUIMenuWidth(), tGMT.getRageUIMenuHeight(), "gmt_aaui", "gmt_aaui"))
...
RegisterCommand('aamenu', function()
    TriggerServerEvent('GMT:openAAMenu')
end)

tGMT.addBlip(495.36367797852,-1329.1535644531,29.339862823486, 446, 5, "AA Mechanic")

function tGMT.openAAMenu()
