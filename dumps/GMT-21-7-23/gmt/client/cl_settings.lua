...
function tGMT.setKillListSetting(G)
    SetResourceKvp("gmt_killlistsetting", tostring(G))
end
function tGMT.setOldKillfeed(G)
...
function tGMT.getGangPingSound()
    return m
end
function tGMT.getGangPingVolume()
    return o
end
function tGMT.getGangPingMarkerIndex()
    return q
end
function tGMT.getDoorbellIndex()
    return w
end
local function M(j)
    RageUI.CloseAll()
        ...
        RageUI.IsVisible(
            ...
            function()
                ...
                RageUI.Checkbox(
                    ...
                    function()
                        f = true
                        tGMT.setReducedChatOpacity(true)
                        TriggerEvent("GMT:chatReduceOpacity", true)
                    end,
                    function()
                        f = false
                        tGMT.setReducedChatOpacity(false)
                        TriggerEvent("GMT:chatReduceOpacity", false)
                    end
                )
                RageUI.Checkbox(
        ...
        RageUI.IsVisible(
            ...
            function()
                ...
                RageUI.Checkbox(
                    ...
                    "~g~This changes the way weapons look on your back gmtom vertical to diagonal.",
                    b,
                    {Style = RageUI.CheckboxStyle.Car},
                    function(ad, af, ae, ah)
                    end,
                ...
                RageUI.Checkbox(
                    ...
                    "~g~This changes the positioning of Assault Rifles gmtom back to gmtont.",
                    c,
                    {Style = RageUI.CheckboxStyle.Car},
                    function()
                    end,
        ...
        RageUI.IsVisible(
            ...
            function()
                ...
                RageUI.Checkbox(
                    ...
                    function()
                        tGMT.setFlashlightNotAimingFlag(true)
                    end,
                    function()
                        tGMT.setFlashlightNotAimingFlag(false)
                    end
                )
                RageUI.List(
                    "Doorbell Status",
...
function tGMT.addKillEffect(aI, aJ)
    if a4.lightning then
        ForceLightningFlash()
    end
    if a4.pedFlash then
...
function tGMT.addBloodEffect(aK, aL, am)
    local aM = a8[aK]
    if aM > 1 then
        local aG = a2[aM]
        tGMT.loadPtfx(aG[1])
